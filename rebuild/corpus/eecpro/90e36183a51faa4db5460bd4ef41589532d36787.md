...
Model variables can be exported to files with the extensions .mdv ![](../Pictures/icon_exportvariables.png) and imported again to a model ![](../Pictures/icon_importvariables.png).
...
Export: using icon ![](../Pictures/icon_exportvariables.png) or Popup Menu > Export

Import: using icon ![](../Pictures/icon_importvariables.png) or Popup Menu > Import
