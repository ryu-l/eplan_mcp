...
The Job was always triggered by a File-Trigger, i.e. an IMX file that was copied into the <incomingFolder> directory has triggered the processing.
...
### [ClosedContent of the jobdef4.jmx:](javascript:void(0);)
