...
The first Job definition is intended to achieve that a configuration is created on the basis of the EOX file Tutorial\_JobServer.eox.
...
### [ClosedContents of the jobDef1.jmx](javascript:void(0);)
