...
Determines all mechatronic components of the highest level of the specified libraries.
...
The following script example (ScriptingExamples.getAllMechatronicTopLevelComponents) finds a list of the imported libraries and from this the mechatronic components of the top level.
...
The method TypeClass.findType() finds the library component Util to execute the method getAllMechatronicTopLevelComponents contained in it (see row 19).

Information is output in the message log (see rows 7, 17, 22 and 25).
