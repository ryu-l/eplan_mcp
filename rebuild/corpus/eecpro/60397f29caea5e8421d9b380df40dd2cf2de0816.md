...
Selected libraries/projects are identified with a check mark ![](../Pictures/selection_check.png), while the dependent libraries/projects are identified by a square ![](../Pictures/selection_square.png).
...
### [ClosedAdding/merging](javascript:void(0);)
