...
### [ClosedCreating the command for the import of a library](javascript:void(0);)
...
A table is shown below with the specification of type names, method names and method arguments.
...
### [ClosedCreating the SequenceSelectionAction for the update of extension points](javascript:void(0);)
...
### [ClosedCreating the Form-UI for Feeder](javascript:void(0);)
