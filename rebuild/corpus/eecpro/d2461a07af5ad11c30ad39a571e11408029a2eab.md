...
One example of a customer-specific presentation of the job status is the Eplan DataPortal website, which is provided by each EEC. It is located in the <EEC\_Installation\_Folder>install\jobserver\htmlTemplates\DataPortalTemplate folder.
