...
- Component method: For a library component, methods are defined in the methods editor. These can be called in the <action> element by prefixing the method name with a colon (<action name=":Method\_name"/>).
