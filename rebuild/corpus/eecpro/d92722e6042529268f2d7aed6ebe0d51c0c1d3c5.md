...
In the first row of the table the cells of column 2 and 3 are connected.
...
In the first column of the table the cells of row 2 and 3 are connected. The attribute value for rowSpan is calculated by means of a formula.
