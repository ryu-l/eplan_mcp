# Content of the schema file Parameter.xsl

The Parameter.xsl schema file is included in the EEC scope of delivery and is located in the following folder after EEC has been installed:

```
<EEC-Installations-Ordner>\install\importschemas\
```

Using this schema file each row of an Excel or CSV file is imported as a parameter and parameter value. The parameters must already exist in the project.
...
### [ClosedContent of the schema file Parameter.xsl](javascript:void(0);)
