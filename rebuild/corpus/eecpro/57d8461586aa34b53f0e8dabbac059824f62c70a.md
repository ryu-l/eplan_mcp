...
| **Annotation** | |
| Opens the specified FormUI editor during the start and displays it.  Can be used instead of the combination -Dcom.mind8.formui.perspective.form and -Dcom.mind8.formui.perspective.form-id and contains both specifications in one.  Example:   ``` -Dcom.mind8.formui.perspective.editor=Feeder.Mechatronic.Feeder#Page:start ``` | |
