...
The resource folder can be backed up using a compression program, for example, 7-ZIP (see [Backing up resources folders](admin_h_backup_resourcefolder.htm)). By assigning the proper names to the zipped files, the backed-up files can be allocated easily.
