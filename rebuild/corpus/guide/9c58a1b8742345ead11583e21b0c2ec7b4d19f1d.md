...
- There are prepared or inserted macros in the project. Tab Master data > Command group Macros > Navigator. You have marked one or more macros in the Macros - <Project name> dialog. Select the Update macros popup menu item. Click [â¦] next to the Settings field in the Update macros dialog.
