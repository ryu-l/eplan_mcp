...
| Motor | Motor with PE, 4 connection points | Three-phase motor | M | M | M | MTR | M |
| PLC connection point | PLC connection point, power supply, 1 connection point | Network / bus cable connection point, output | A | K | K | PLC | K |
...
| M0023 | Page 002 with page name 2, minimum number of loops 3 and filler characters 0. The page appears after the identifier M and before the counter 3. |
