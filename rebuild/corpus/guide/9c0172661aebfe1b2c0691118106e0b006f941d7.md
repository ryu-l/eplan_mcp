...
- You have selected one or more pages in the page navigator. Popup menu item Copy. In the page navigator, click the position where the copied pages are to be inserted. Popup menu item Insert. Select the DT tab.
- Tab Home > Command group Page > Drop-down button Page macro > Insert. In the selection dialog, select a page macro and click [Open]. Select the DT tab.
