...
Using direct editing, you can activate an editing mode that allows you to directly modify individual graphical texts (tab Edit > Command group Options > Direct editing). Once this editing mode is switched on, an editing frame will be displayed and the ![](../Pictures/Gui/ALL/inplaceeditinggui_icon_as.png) icon will appear on the status bar.
