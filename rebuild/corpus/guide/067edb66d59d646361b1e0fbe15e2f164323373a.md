...
You have opened a project. You have inserted placeholder objects in this project.

- Tab Master data > Command group Macros > Placeholder objects
- Tab Devices > Command group Project options > Placeholder objects
- You have opened an editor such as the graphical editor, the plot frame editor, etc. Tab View > Command group Navigators > Drop-down button Open > Placeholder objects.

All placeholder objects in the project are listed in this dialog. You can use the popup menu to edit the properties of the placeholder objects and assign value sets to them.
