# Tabs "Hydraulics" / "Pneumatics" / "Cooling" / "Lubrication" / "Cooling lubricant" / "Gas engineering" / "Process engineering"

[![Closed](../../Skins/Default/Stylesheets/Images/transparent.gif)Dialog call:](javascript:void(0);)

You have opened a project. File > Settings > Projects > "Project name" > Connections > Properties. Select the desired tab: Hydraulics, Pneumatics, Cooling, Lubrication, Cooling lubricant, Gas engineering, or Process engineering.
...
During a part selection, the value entered in parts management in the Properties tab is transferred into this property and overrides the default.
