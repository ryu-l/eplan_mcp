...
- Status: Status information such as (e.g.) "Not stored" or "Identical"
- Name: File name of the master data object, without file extension
- Type: Master data type (symbol library, form for title page, plot frame, etc.)
...
| Compressed symbol libraries in the project | Replaces compressed symbol libraries in the project master data by symbol libraries from the system master data. |
