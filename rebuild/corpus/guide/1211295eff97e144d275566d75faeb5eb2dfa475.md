...
#### Identification of fluid power lines in accordance with ISO 1219-2

The standard ISO 1219-2 requires that fluid power lines be identified in accordance with a specific ID code. This ID code is formed from the following components:
...
- Pipe:  
  At this line type either the Nominal outside diameter together with the wall thickness in mm has to be specified or the Outside diameter and the Inner diameter in mm.
