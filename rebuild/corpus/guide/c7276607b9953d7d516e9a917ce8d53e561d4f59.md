...
Multiple potential definition points or connection points with the same names are allowed. Their properties supplement each other. If there is a conflict in their properties, then an error message is generated (even if they are at different potentials).
