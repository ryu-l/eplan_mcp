...
- You have opened a project that contains layout spaces. You have opened a project page in the graphical editor. You have inserted a 2D drilling view (Tab Insert > Command group View > 2D drilling view) and placed it. In the 2D drilling view dialog, select the View tab.
...
Here you can specify what is to be displayed in the 2D drilling view. You can also further restrict the content of the layout space that is displayed. Click [...] to open the [3D object selection](gededit3dgui_d_3dobjektauswahl.htm) dialog and select the objects to be displayed in the 2D drilling view.
...
- Item labeling: Here you can specify which scheme is to be applied for labeling the items in the 2D drilling view. Click [...], to open the [Settings: Labeling](gededit3dgui_d_einstellbeschriftung.htm) dialog and to select or create a new scheme.
...
- Display item silhouettes: If this check box is activated, the basic outlines of extruded items (e.g., mounting rails and wire ducts) and the lateral boundary lines of the 3D object generated from the basic outline will be displayed. Disabling this setting will accelerate the output of complex 2D drilling views, but will impair the quality of the illustration of the items.
