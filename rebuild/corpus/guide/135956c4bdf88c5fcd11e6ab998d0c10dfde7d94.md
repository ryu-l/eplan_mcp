...
You have opened a project. You have generated a reference project. File > Revision control > Command group Project > Property comparison > Compare projects. In the Compare properties of projects dialog, click [...] beside the Structure identifier setting field.

In this dialog, you specify which structure identifiers in the reference project are to be replaced by which structure identifiers from the current project, and you can save these settings in a separate scheme. The specified structure identifiers are then no longer seen as different during a property comparison of projects.
...
| (Delete) | Deletes the currently marked rows. Multiple selection is possible. |
