...
- You have selected a terminal in the graphical editor. Popup menu item Properties. In the Properties <...> dialog, select the Terminal tab.
...
- You generate a terminal in the terminal strip navigator using the Generate terminal popup menu item.

In this dialog, you can specify or modify the properties of terminals. Properties which cannot be changed are grayed out.
