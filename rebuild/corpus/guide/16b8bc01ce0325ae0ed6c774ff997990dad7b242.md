# P502012: Part property 'Order number' is empty

### Cause

In the parts database to be checked a part was found where no information for the Order number property is entered.
...
3. In the property table in the hierarchy level General enter the required information in the value field of the property Order number.
4. Click [Apply].
