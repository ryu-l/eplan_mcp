...
- You have opened a project. File > Settings > Projects > "Project name" > Graphical editing > Automatic dimensioning. Select the Dimensioning tab.
...
You can edit the properties of the automatic dimensioning in this table. The following hierarchy levels are available here which you can open by clicking the ![](../Pictures/Gui/ALL/all_expand_hierarchy_as.png) sign:
