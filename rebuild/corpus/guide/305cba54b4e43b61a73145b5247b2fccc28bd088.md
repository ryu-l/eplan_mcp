...
1. Select a dimensioning type for a linear dimension in the ribbon, for example by using following commands: Tab Insert > Command group Dimensioning > Linear dimension.
