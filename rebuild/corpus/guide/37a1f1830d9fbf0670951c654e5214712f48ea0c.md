...
You have inserted a macro in the schematic that contains components for PLC connection points with a multi-line representation type. In the navigator, you have already created functions for PLC connection points in the "Overview" representation type. Using the "Assign" function, you can move PLC connection points from the navigator to the components of the macro and assign them with a single click.
