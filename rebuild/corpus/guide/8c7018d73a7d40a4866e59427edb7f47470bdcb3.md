...
- File > Settings > Projects > "Project name" > Management > Device selection.
- You have selected a main function in the graphical editor or in a navigator. Popup menu item Properties. Select the Parts tab. Button [Settings] > Device selection (or Button [Device selection]. Select the [Settings] button in the subsequent dialog.
