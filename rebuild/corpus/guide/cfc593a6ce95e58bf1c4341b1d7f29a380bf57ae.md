...
You have opened a project. Tab Home > Command group Find > Find.
...
The "Displayed DT" is shown as a search result. Use the Replace command to change only the displayed DT and, within that, only the elements without structural elements. If no DT is displayed on the component, i.e., a  [DT adoption](devicetaggui_k_bmkuebernahme.htm) exists, nothing is replaced.
