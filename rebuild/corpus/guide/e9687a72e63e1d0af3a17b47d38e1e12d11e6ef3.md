...
If you have the multiply nested structure boxes =A2+O2, =A3+O3, and =A4+O4, and have activated the Structure box check box (left part of the illustration), then the fuse receives the DT =A2.A3.A4+O2.O3.O4-F3; if the Structure box check box is deactivated (right side), then the fuse is called =A4+O4-F3.
