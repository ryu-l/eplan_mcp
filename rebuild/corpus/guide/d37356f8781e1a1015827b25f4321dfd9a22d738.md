...
- You have selected a net definition point in the graphical editor. Popup menu item Properties. In the Properties <...> dialog, select the Net connections tab.
- Tab Insert > Command group Cables / connections > Drop-down button Connection > Net definition point. In the Properties <...> dialog, select the Net connections tab.
...
If you selected the Manage saddle jumper connection points in the net definition point check box in the project settings (File > Settings > Projects > "Project name" > Connections > General), symbol connection points with the connection point type "Saddle jumper" are also displayed here. However, additional function connection points for saddle jumpers are not displayed.
...
| Button | Meaning |
| --- | --- |
| (Edit) | Opens the property dialog for the connection between the selected connection point and the one following it in the list so that the connection properties can be edited. |
...
You can select the complete daisy chain by clicking on the separator underneath it. This allows you to move the entire daisy chain using the arrow buttons or to delete it using the ![](../Pictures/Gui/ALL/all_delete_as.png) button.
