...
- Tab Devices > Command group Plugs > Navigator
- You have opened an editor such as the graphical editor, the plot frame editor, etc. Tab View > Command group Navigators > Drop-down button Open > Plugs
...
| Generate plug definition | Generates a plug definition via the selection Male and female pins, Only male pins or Only female pins, in as far as such a plug definition does not yet exist for the device. A device can have a maximum of three different plug definitions (for male pins, female pins or male-female pin combinations). |
...
| Number pins | Opens the Number pins dialog. It is there that you can determine the special formatting for the pin designations. |
