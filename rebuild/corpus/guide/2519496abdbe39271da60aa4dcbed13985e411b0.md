...
For cables and shields, the path function text is determined from the graphically first associated connection definition point. Only if there is no connection definition point, is the path function text determined starting from the insertion point of the cable definition line or the shield.
