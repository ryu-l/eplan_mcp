...
- File > Settings > Projects > "Project name" > Devices > Cable (automatic). Next to the Automatic cable selection field, click [...].
- Tab Connections > Command group Cables > Drop-down button Reassign all > Generate cables automatically. In the Generate cables automatically dialog, in the Automatic cable selection group box, click [...] next to the Settings field.
- You have opened the cable navigator, for example via the following commands: Tab Connections > Command group Cables > Navigator. Select multiple entries with cables and select the Automatic cable selection popup menu item. Click [...] in the Settings field of the Automatic cable selection dialog.
...
| Button | Meaning |
| --- | --- |
| (New) | Opens the Part selection dialog. The selected part is added to the preselection list. |
...
Minimum number of spare cable connections:

In this field you enter the minimum number of connections to activate the value in the Spare cable connections field.
