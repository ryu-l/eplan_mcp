...
- You have selected the function of a general device in the graphical editor or in a navigator. Popup menu item Properties. Select the <Function category> tab.
...
If the project setting Adopt connection point designation has been activated (File > Settings > Projects > "Project name" > Management > Compatibility), the connection point designations of the functions adopting the DT from the current function are additionally displayed.
