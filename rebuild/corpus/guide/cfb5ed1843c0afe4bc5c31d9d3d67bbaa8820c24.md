...
- You have selected terminals in the graphical editor, the terminal strip navigator, or in the device navigator. You have selected pages or a project in the page navigator. Tab Devices > Command group Terminals > Number.
- You have selected terminals in the graphical editor or in the Terminal strips navigator. Tab Devices > Command group Terminals > Terminal strip. Select one or more terminals. Select the Number terminals popup menu item.
- You have selected pins in the graphical editor, the plug navigator, or in the device navigator. You have selected pages or a project in the page navigator. Tab Devices > Command group Plugs > Number.
- You have selected pins in the graphical editor or in the plug navigator. Tab Devices > Command group Plugs > Plugs. Select one or more pins. Select the Number pins popup menu item.
...
- Page-based: The terminals / pins will be numbered by page in the sequence they are reported. The sequence of the reports is defined in the plot frame. For example projects according to the IEC standard are numbered by column, whereas projects according to the NFPA standard are numbered by row.
- Cable-based: The terminals / pins are numbered in the sequence of the placed cable connections.
...
The number of places is determined from the online numbering format (File > Settings > Projects > "Project name" > Device > Numbering (online)).
