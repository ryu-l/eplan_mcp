...
- You have selected a wire harness definition in the graphical editor. Popup menu item Properties. Select the Wire harness tab in the Properties <...> dialog.
...
Use this tab to edit the properties of a wire harness.
