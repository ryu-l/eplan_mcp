...
In order to find unplaced connections faster, you can show the Type of administration property in the column configuration for the list view of the connections navigator (via the popup menu item Configure representation).
