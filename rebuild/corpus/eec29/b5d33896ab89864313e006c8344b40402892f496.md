...
| substring([Integer](glossary_o_integer.htm) start, Integer end) | | | |
| --- | --- | --- | --- |
| Argument | Integer | start | Start position |
| Integer | end | End position |
| Return value | [String](glossary_o_string.htm) | New character string mit characters from position x until position y of the original (the counts starts at 0) | |
