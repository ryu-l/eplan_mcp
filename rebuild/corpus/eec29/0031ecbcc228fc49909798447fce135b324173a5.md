...
| [Component](glossary_o_component.htm) | Super class | [Parameter](glossary_o_parameter.htm) | Value |
| --- | --- | --- | --- |
| abstractEndBracket | Device | Coordinate |  |
| EPN |  |
| Mate |  |
| [Plug](glossary_o_plug.htm) |  |
| Position |  |
| abstractMountingRail | MountingRail | Coordinate |  |
| Dimension |  |
| [DT](glossary_o_bmk.htm)\_Code | MR |
| DT\_Counter |  |
| EPN |  |
| Id |  |
| Plug | PlaneMounted |
| [Socket](glossary_o_socket.htm) | =$DT\_Code + $DT\_Counter |
