...
If a new parameter has been created, or if a parameter already exists with the stated name, it is assigned to the text object whose resource has just been read in.