...
The Actuator and Sensor parameters are now installed in the Axis and Separator [Function](glossary_o_fc.htm) units, in order to determine lists of symbols of all sensors and actuators therein.
