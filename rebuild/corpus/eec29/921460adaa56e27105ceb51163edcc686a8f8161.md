...
11. Add to the list of Required [Plug](glossary_o_plug.htm)-ins the plug-in com.mind8.project.exchange (1.0.1).
...
18. Enter the [EOX](glossary_o_eox.htm) file name of a specific model in the modelID field if the plug-in is relevant only to this model. Do not enter an EOX file name if the PX updates are to be applied to all PX files.
