...
The ParameterBoolean parameter is filled with the value ='true'. Since this is not a valid [Boolean](glossary_o_boolean.htm) value, false is entered as the result.

Formula errors are displayed for the parameters ParameterDouble and ParameterInteger because the imported values cannot be interpreted as [Double](glossary_o_double.htm) or [Integer](glossary_o_integer.htm) respectively.
