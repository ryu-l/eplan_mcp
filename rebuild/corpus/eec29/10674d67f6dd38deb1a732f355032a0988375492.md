...
![](../Pictures/Gui/ALL/example.png)[![Closed](../../Skins/Default/Stylesheets/Images/transparent.gif)Example code for the definition of the safety circuit as a hexagon:](javascript:void(0);)
