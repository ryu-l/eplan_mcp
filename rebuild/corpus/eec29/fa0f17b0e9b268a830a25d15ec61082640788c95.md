...
The name of the sequence parameter can be changed via the (Model > Model variables menu) Disciplines > Fieldbus > Name of the parameter for the sequence model variable.