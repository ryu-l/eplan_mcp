...
- **Image:** The icon shown here is displayed both in the popup menu and as a button on the toolbar when the Project explorer toolbar button option is enabled.
...
- **Pop-up path:** Defines the path to the action within the popup menu. The individual path entries are separated by a forward slash. For example, menu/sub menu/create.
- **Displayed Name:** Action name displayed in the popup menu.
- **Adding a button to the project explorer toolbar****:** A button that can be used to start the action is added to the toolbar in the project explorer view.
