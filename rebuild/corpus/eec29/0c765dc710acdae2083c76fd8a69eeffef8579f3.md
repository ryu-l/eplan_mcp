...
The installed actuators and sensors obtain the values for the structure parameters IO\_Place, IO\_Places, and IO\_IncomingBus from their parent mechatronic component, here the [Function](glossary_o_fc.htm) unit.
