...
| --- | --- | --- | --- |
| Argument | [String](glossary_o_string.htm) | prefix | Absolute path to the parameters to be deleted. |
| String[ ] | parameterNames | Array of parameter names. |
| Return value | [Boolean](glossary_o_boolean.htm) | true = all parameter names have been deleted successfully. false = no parameter name has been deleted. | |