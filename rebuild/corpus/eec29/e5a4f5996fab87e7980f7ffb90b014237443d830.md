...
This section shows how several arguments are passed so that key-value pairs are stored in a parameter of the Map type. To this purpose the [EOX](glossary_o_eox.htm) file Feeder.eox that was created with Test 4 is to be used as the basic model.
...
![](../Pictures/Gui/ALL/example.png)[![Closed](../../Skins/Default/Stylesheets/Images/transparent.gif)Content of the jobdef5.jmx:](javascript:void(0);)
...
2. Continue with section [Test 5 - Writing key-value pairs in the Map parameter via a webserviceTrigger](tutjobs_h_test5.htm).