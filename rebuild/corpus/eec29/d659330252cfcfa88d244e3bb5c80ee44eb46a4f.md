# Importing CSV or Excel file with standard scheme
...
![](../Pictures/Gui/ALL/example.png)[![Closed](../../Skins/Default/Stylesheets/Images/transparent.gif)Example Excel file for the import:](javascript:void(0);)
...
| --- | --- | --- | --- |
| GripperA | 1 | ='1' | [String](glossary_o_string.htm) |
| GripperB | 2 | ='2' | String |
| GripperC |  | ='' | String |
