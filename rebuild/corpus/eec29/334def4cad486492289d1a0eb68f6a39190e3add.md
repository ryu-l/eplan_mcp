...
[Placeholder](glossary_o_placeholder.htm) for concrete specifications of images. Can be used as a substitute for group head. In addition to the definitions of property-id, which are listed in the table below, the definitions under [figureBase](refgraph2d_r_figurebase.htm) also apply.
