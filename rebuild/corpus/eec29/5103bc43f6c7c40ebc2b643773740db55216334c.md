...
The resource path validation displays the input of an invalid path in the editor as an error. Outside of editors (e.g., [EOX](glossary_o_eox.htm) Import), this is displayed as a warning.
...
The Attributes page of the discipline components represents the three possible states of resources as well as the respective actions that are possible transparently:

![](../Pictures/attribute_resource_location.png)
