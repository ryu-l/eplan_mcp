...
To insert the code from child discipline components into the code of an POU, the [Plug](glossary_o_plug.htm)-[Socket](glossary_o_socket.htm) principle is used in the comments.
...
![](../Pictures/Gui/ALL/example.png)[![Closed](../../Skins/Default/Stylesheets/Images/transparent.gif)Example code for line comment:](javascript:void(0);)

```
// M8B_Socket:CodeSocket1_M8E
```

![](../Pictures/Gui/ALL/example.png)[![Closed](../../Skins/Default/Stylesheets/Images/transparent.gif)Example code for block comment:](javascript:void(0);)
...
![](../Pictures/Gui/ALL/example.png)[![Closed](../../Skins/Default/Stylesheets/Images/transparent.gif)Example for replacement:](javascript:void(0);)
