# Parameter Name For Installation Site List

Path to model variable:

Disciplines > ECAD > EPLAN Electric P8 > Structure identifier management

With the Parameter name for the sequence of installation site model variable the name of a parameter is specified that stores the list of installation sites in a specific sequence.
