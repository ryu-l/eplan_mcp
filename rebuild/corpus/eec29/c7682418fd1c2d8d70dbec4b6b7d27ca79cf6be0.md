...
- The host computer has 64-bit Java [JDK](glossary_o_jdk.htm) or respectively [JRE](glossary_o_jre.htm) version 7 installed (see [Software requirements and approvals](admin_r_it_reqs_software.htm)).
...
[Installation and configuration of the Web EEC Server](admin_h_installation_web_eec_server.htm)

[Web EEC installation and configuration](admin_h_installation_web_eec_configuration.htm)

[Installation of EEC Server](admin_h_installation_web_eec_eec_server.htm)

[Calling the Web EEC](admin_h_installation_web_eec_call.htm)

[SSL configuration of the Web EEC Server](admin_h_installation_web_eec_server_ssl_configuration.htm)