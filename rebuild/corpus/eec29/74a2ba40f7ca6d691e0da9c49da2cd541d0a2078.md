...
| --- | --- | --- |
| classToInstantiate | Object | [Class](glossary_o_class.htm) to be instantiated. |
...
| instanceName | [String](glossary_o_string.htm) | The new name of the instance. If the name already exists a name collision clearing is executed. |
...
| instantiateExtensions | [Boolean](glossary_o_boolean.htm) | The values true or false control the calculation of extensions in the new instance. |
