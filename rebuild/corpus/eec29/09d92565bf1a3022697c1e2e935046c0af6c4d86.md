# Part 4 â Importing a CSV file via an action
...
![](../Pictures/Gui/ALL/example.png)[![Closed](../../Skins/Default/Stylesheets/Images/transparent.gif)Content of the Template\_CSV.imx:](javascript:void(0);)
...
![](../Pictures/Gui/ALL/example.png)[![Closed](../../Skins/Default/Stylesheets/Images/transparent.gif)Content of the Parameters.csv:](javascript:void(0);)
...
11. Click the symbol ![](../Pictures/Gui/ALL/new.png) (Add individual argument).
...
![](../Pictures/Gui/ALL/example.png)[![Closed](../../Skins/Default/Stylesheets/Images/transparent.gif)Content of the UI configuration:](javascript:void(0);)
