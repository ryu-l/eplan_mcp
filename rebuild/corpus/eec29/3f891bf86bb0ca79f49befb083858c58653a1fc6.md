...
| --- | --- | --- | --- |
| Argument | [String](glossary_o_string.htm) | oldPlaceholderAbsPath | Old absolute path of the placeholder. |
| String | newPlaceholderAbsPath | New absolute path of the placeholder. |
| Return value | [Boolean](glossary_o_boolean.htm) | true = the absolute path of the placeholder has been replaced. true = no absolute path of the placeholder has been replaced. | |