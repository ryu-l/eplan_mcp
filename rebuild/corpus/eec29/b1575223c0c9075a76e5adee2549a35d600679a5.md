...
[Model](glossary_o_modell.htm) variables:
...
Using ![](../Pictures/Gui/button_fill_modelvariable.png), a default value is entered for all variables for which a value has not been set yet.
...
Prior to any model export to an [EOX](glossary_o_eox.htm) file, it is recommended that the absolute names of components in formulas be updated.