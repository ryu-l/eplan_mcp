...
| --- | --- | --- |
| fromAddress | [String](glossary_o_string.htm) | E-mail address of the sender. May not be empty. No validity check takes place. |
...
- Dde.eplan.eec.mail.password: Defines the password for the authentication (optional).
