...
If a conflict during the import of an [EOX](glossary_o_eox.htm) file can be solved only at the workspace level, the synchronization process must be aborted. After the conflict resolution, the EOX file must be imported again.
