...
| [Parameter](glossary_o_parameter.htm) | Usage |
| --- | --- |
...
| Name of the parameter for the FB comment (default = FBSimaticComment) | This parameter contains the comment for the FB and is only taken into account when creating FBs. |
...
[Definition of the hierarchy of the symbol-list objects](eecplc_k_symbollist_define_hierarchy_of_symbollist_objects.htm)

[The body object](eecplc_k_symbollist_body.htm)

[The section](eecplc_k_symbollist_chapter.htm)

[The line](eecplc_k_symbollist_line.htm)