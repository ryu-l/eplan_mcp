...
![](../Pictures/Komposition_8.png)

4. Rename Axis to X\_Axis and Axis2 to Y\_Axis: Select the components to be renamed, and with another click switch to the editor mode (identifiable by the fact that only the text without a symbol is highlighted). Alternatively â as in the Library Catalog or Project Catalog view â you can switch to the editor mode using the [F2] function key.