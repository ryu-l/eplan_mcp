...
- **[Integer](glossary_o_integer.htm)**: +/-, only numbers without decimal points
- **[Double](glossary_o_double.htm)**: +/-, numbers, decimal points, e
...
Check boxes store the value of a parameter of type [Boolean](glossary_o_boolean.htm). Typically, the parameter name is shown beside the box.
...
[Display of modified parameter values in radio buttons and drop-down list boxes](refformui_r_display_changed_parametervalues.htm)