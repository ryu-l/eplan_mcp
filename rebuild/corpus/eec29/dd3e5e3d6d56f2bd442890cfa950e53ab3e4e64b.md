# addWarning( Object reportingInstance, String causeObjectID, String topic, String message, Throwable cause)

Adds to the UMC a warning of the LIBRARY type.

| addWarning( Object reportingInstance, [String](glossary_o_string.htm) causeObjectID, String topic, String message, Throwable cause) | | | |
| --- | --- | --- | --- |
