# Commands for inserting and moving components
...
- [Command](glossary_o_command.htm) for inserting from the project:
...
![](../Pictures/Gui/ALL/example.png)[![Closed](../../Skins/Default/Stylesheets/Images/transparent.gif)Example code for the definition of an element that may be dragged into the diagram, creating a new instance in the process:](javascript:void(0);)
...
![](../Pictures/Gui/ALL/example.png)[![Closed](../../Skins/Default/Stylesheets/Images/transparent.gif)Example code for the definition of an element that may be dragged into the diagram:](javascript:void(0);)
...
![](../Pictures/Gui/ALL/example.png)[![Closed](../../Skins/Default/Stylesheets/Images/transparent.gif)Example code for the definition of an element that may be dragged from one diagram into another:](javascript:void(0);)
