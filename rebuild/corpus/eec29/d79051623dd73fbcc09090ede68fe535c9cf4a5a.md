...
Enter the name of a parameter. Add this parameter to the root projects of the disciplines. The value of the parameter in the discipline components defines the name of a discipline root project.

![](../Pictures/Gui/ALL/example.png)[![Closed](../../Skins/Default/Stylesheets/Images/transparent.gif)Example for the discipline ECAD:](javascript:void(0);)
