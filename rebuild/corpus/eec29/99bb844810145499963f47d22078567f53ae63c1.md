...
| --- | --- | --- | --- |
| Argument | [String](glossary_o_string.htm) | parentName | Absolute path to the superordinate project component. This specification is mandatory. |
...
| [Boolean](glossary_o_boolean.htm) | deleteAlsoParameters | Option whether to delete the parameters of the project component as well. true = delete parameters. false = do not delete parameters. |
