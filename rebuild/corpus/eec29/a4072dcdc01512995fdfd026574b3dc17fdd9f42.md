...
The modularization of discipline-specific resources is accomplished via the **[Plug](glossary_o_plug.htm)-[Socket](glossary_o_socket.htm) concept**. The socket is viewed here as a receptacle that one or more plugs can plug into. For example, a fragment of a schematic may contain a socket where several other fragments can be positioned via plugs.
