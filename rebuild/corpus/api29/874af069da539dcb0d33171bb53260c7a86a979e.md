# CreateTransient Method (Image)

CreateTransient Method (Image)

Creates transient and not placed Image object.
...
*oProject*
:   [Eplan.EplApi.DataModel.Project](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Project.html) the Image will be assign to.
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Image~CreateTransient)