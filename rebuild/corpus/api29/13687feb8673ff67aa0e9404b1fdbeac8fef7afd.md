# BasePointMate Class Members

BasePointMate Class Members

The following tables list the members exposed by [BasePointMate](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.BasePointMate.html).
