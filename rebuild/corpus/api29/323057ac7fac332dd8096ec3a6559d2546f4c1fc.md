# MDObjectCreationException Class Members

MDObjectCreationException Class Members

The following tables list the members exposed by [MDObjectCreationException](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDObjectCreationException.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDObjectCreationException)