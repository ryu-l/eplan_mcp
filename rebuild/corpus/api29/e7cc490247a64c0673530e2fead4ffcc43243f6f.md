# Exists Method (ConnectionDefinitionPointPropertyList)
...
| --- | --- |
| [Exists(ConnectionDefinitionPoint)](topic207.html) | Checks property existence for used obiect. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionDefinitionPointPropertyList~Exists)