# ARTICLE_USAGE Property (MergedArticleReferencePropertyList)

ARTICLE\_USAGE Property (MergedArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_USAGE(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLE_USAGE(Int32).html) | Procurement # 22144. This property isn't indexed. |
| [ARTICLE\_USAGE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLE_USAGE().html) | Procurement # 22144. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLE_USAGE)