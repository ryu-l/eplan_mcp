...
```
public:
new property MDPropertyValue^ default [Properties.MDPartsDatabaseItem,int] {
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~Property)