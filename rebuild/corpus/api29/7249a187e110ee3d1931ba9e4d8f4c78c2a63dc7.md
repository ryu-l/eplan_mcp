# DESIGNATION_INSTALLATIONNUMBER_PART(Int32) Property

DESIGNATION\_INSTALLATIONNUMBER\_PART(Int32) Property
...
```
```
public PropertyValue DESIGNATION_INSTALLATIONNUMBER_PART( 
   int index
) {get; set;}
```
```
...
[Overload List](topic2433.html)

---

EPLAN API , 21.05.2020, Â© by EPLAN Software and Service GmbH and Co. KG. All rights reserved.

[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentTemplatePropertyList~DESIGNATION_INSTALLATIONNUMBER_PART(Int32))