...
- [C#](#i-tab-content-19d6a480-7a3a-49e6-8f56-bda81b07473d)
...
| Public Property | [PATHTEXT\_FUNCTIONS](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PathTextPropertyList~PATHTEXT_FUNCTIONS.html) | Overloaded. Affected functions # 19800. This property isn't indexed, and is read-only. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.PathTextPropertyList)