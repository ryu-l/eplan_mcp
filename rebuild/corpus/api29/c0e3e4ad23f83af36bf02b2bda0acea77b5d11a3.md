# DimensionCirclePropertyList Class Members

DimensionCirclePropertyList Class Members

The following tables list the members exposed by [DimensionCirclePropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionCirclePropertyList.html).
...
| Public Property | [INSTANCE\_SIZE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionCirclePropertyList~INSTANCE_SIZE.html) | Overloaded. Font size # 19017. This property isn't indexed. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionCirclePropertyList)