...
```
```
public class MountingRail : BarBase, Eplan.EplApi.DataModel.IArticleUser, Eplan.EplApi.DataModel.IFunctionBase
```
```

```
```
public ref class MountingRail : public BarBase, Eplan.EplApi.DataModel.IArticleUser, Eplan.EplApi.DataModel.IFunctionBase
```
```
...
| Public Property | [Length](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.MountingRail~Length.html) | Overridden. Returns length of this object. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.MountingRail)