# MDDatabaseConnectionException Class Members

MDDatabaseConnectionException Class Members

The following tables list the members exposed by [MDDatabaseConnectionException](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDDatabaseConnectionException.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDDatabaseConnectionException)