# WRITEPROTECTED Property (PagePropertyList)
...
| --- | --- |
| [WRITEPROTECTED(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PagePropertyList~WRITEPROTECTED(Int32).html) | Change protection # 3014. This property isn't indexed, and is read-only. |
| [WRITEPROTECTED](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PagePropertyList~WRITEPROTECTED().html) | Change protection # 3014. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PagePropertyList~WRITEPROTECTED)