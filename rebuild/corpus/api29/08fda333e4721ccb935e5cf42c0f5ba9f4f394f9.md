# NotLockedException Class

NotLockedException Class

Throw when object was accessed but not locked.
...
```
```
public class NotLockedException : DataModelException
```
```

```
```
public ref class NotLockedException : public DataModelException
```
```
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [NotLockedException Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.NotLockedException~_ctor.html) | Overloaded. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.NotLockedException)