# DMDELETEDOBJECTINFO_REVISION_LOG_CHANGE(Int32) Property

DMDELETEDOBJECTINFO\_REVISION\_LOG\_CHANGE(Int32) Property
...
```
```
public PropertyValue DMDELETEDOBJECTINFO_REVISION_LOG_CHANGE( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DeletedObjectInfoPropertyList~DMDELETEDOBJECTINFO_REVISION_LOG_CHANGE(Int32))