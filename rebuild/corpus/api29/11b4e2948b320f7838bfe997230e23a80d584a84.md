...
| --- | --- |
| **BaseException** | An error occurred while restoring the project. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.HEServicesu~Eplan.EplApi.HEServices.Restore~Project(StringCollection,String,String,Boolean,Boolean,UInt32))