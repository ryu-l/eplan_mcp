...
```
```
public class PipingDefinition : PotentialDefinition
```
```

```
```
public ref class PipingDefinition : public PotentialDefinition
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PipingDefinition)