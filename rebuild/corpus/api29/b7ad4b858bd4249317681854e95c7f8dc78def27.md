...
```
```
public class DynamicConnectionLine : SymbolReference
```
```

```
```
public ref class DynamicConnectionLine : public SymbolReference
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DynamicConnectionLine)