# FUNC_PLCGROUP_DATALENGTH_INPUTS_1(Int32) Property

FUNC\_PLCGROUP\_DATALENGTH\_INPUTS\_1(Int32) Property
...
```
```
public PropertyValue FUNC_PLCGROUP_DATALENGTH_INPUTS_1( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Placement3DPropertyList~FUNC_PLCGROUP_DATALENGTH_INPUTS_1(Int32))