# LicensingNotAvailableException Class Members

LicensingNotAvailableException Class Members

The following tables list the members exposed by [LicensingNotAvailableException](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.LicensingNotAvailableException.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.LicensingNotAvailableException)