# DataModelException Class Members

DataModelException Class Members

The following tables list the members exposed by [DataModelException](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DataModelException.html).
