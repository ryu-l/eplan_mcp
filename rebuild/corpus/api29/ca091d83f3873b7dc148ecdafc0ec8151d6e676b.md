# LockedMountingArea Class Members

LockedMountingArea Class Members

The following tables list the members exposed by [LockedMountingArea](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.LockedMountingArea.html).
...
| Public Method | [CreateTransient](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.LockedMountingArea~CreateTransient.html) | Overridden. Create transient `LockedMountingArea` object. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.LockedMountingArea)