...
```
```
public class Page : DocumentBase, IWriteProtection
```
```

```
```
public ref class Page : public DocumentBase, IWriteProtection
```
```
...
- [C#](#i-tab-content-33b1705d-a103-485a-903e-93cf3baf9e56)
...
| Public Method | [PauseWriteProtection](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Page~PauseWriteProtection.html) | Temporarily disables write protection. Note that current write protection |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Page)