...
Only functions with category [Eplan.EplApi.DataModel.Function.Enums.Category.Cable](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Function+Enums+Category.html) or [Eplan.EplApi.DataModel.Function.Enums.Category.Shielding](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Function+Enums+Category.html) can be passed as `oFunction`.
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.HEServicesu~Eplan.EplApi.HEServices.CableService~DoReassignWires(Function,Connection[],Boolean,AnyPropertyId[]))