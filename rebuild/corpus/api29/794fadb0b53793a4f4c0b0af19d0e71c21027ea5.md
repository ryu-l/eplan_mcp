# FUNC_ARTICLE_PLCTEMPLATEREFERENCE(Int32) Property

FUNC\_ARTICLE\_PLCTEMPLATEREFERENCE(Int32) Property
...
```
```
public PropertyValue FUNC_ARTICLE_PLCTEMPLATEREFERENCE( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionPropertyList~FUNC_ARTICLE_PLCTEMPLATEREFERENCE(Int32))