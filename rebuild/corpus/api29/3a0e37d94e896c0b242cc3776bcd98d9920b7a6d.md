...
| --- | --- |
| [ARTICLEREF\_ADDITIONAL\_BOOLFIELD(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~ARTICLEREF_ADDITIONAL_BOOLFIELD(Int32).html) | Suppl. field: Yes / No # 20502. This property isn't indexed. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~ARTICLEREF_ADDITIONAL_BOOLFIELD)