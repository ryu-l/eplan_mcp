# FUNC_PLCDEVICE_ID(Int32) Property

FUNC\_PLCDEVICE\_ID(Int32) Property
...
```
```
public PropertyValue FUNC_PLCDEVICE_ID( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionPropertyList~FUNC_PLCDEVICE_ID(Int32))