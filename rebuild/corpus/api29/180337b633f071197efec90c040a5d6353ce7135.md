# MDPermissionException Class Members

MDPermissionException Class Members

The following tables list the members exposed by [MDPermissionException](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPermissionException.html).
