# TopologyLine Class Members

TopologyLine Class Members

The following tables list the members exposed by [TopologyLine](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TopologyLine.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TopologyLine)