...
FUNC\_ARTICLE\_DESCR3 Property
...
```
```
public PropertyValue FUNC_ARTICLE_DESCR3 {get; set;}
```
```
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentTemplatePropertyList~FUNC_ARTICLE_DESCR3.html)
