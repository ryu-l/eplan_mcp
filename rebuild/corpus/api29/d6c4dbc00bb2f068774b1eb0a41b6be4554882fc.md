# CDP_CON_WIRELENGTH(Int32) Property

CDP\_CON\_WIRELENGTH(Int32) Property
...
```
```
public PropertyValue CDP_CON_WIRELENGTH( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionDefinitionPointPropertyList~CDP_CON_WIRELENGTH(Int32))