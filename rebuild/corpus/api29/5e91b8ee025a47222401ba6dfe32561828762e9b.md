...
| --- | --- |
| [GetNamePrototype(FunctionGroup,UniversalPropertyList,UniversalPropertyList)](topic983.html) | Gets the name prototype for a given function group. For given function group two separate lists with properties used in project structure are created. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Project~GetNamePrototype)