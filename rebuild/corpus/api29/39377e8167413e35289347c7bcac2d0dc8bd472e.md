...
| Public Property | [Category](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionDefinition~Category.html) | Category of FunctionDefinition as enum value. |
...
| Public Property | [Project](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionDefinition~Project.html) | Overridden. Returns the project the StorableObject belongs to. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionDefinition)