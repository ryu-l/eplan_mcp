# ForbiddenOperationException Class Members

ForbiddenOperationException Class Members

The following tables list the members exposed by [ForbiddenOperationException](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ForbiddenOperationException.html).
