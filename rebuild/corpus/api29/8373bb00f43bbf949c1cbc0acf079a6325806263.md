# Placement3D.Enums.AdditionalType Enumeration

Placement3D.Enums.AdditionalType Enumeration

FunctionDefinition is not enough to identify an object for EPLAN Cabinet, so we need an additional enum to do it.
...
```
```
public enum Placement3D.Enums.AdditionalType : System.Enum
```
```

```
```
public enum class Placement3D.Enums.AdditionalType : public System.Enum
```
```
...
   [System.ValueType](#)  
      [System.Enum](#)  
         **Eplan.EplApi.DataModel.E3D.Placement3D.Enums.AdditionalType**
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Placement3D+Enums+AdditionalType)