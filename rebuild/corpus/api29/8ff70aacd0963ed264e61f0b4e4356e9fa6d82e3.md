...
```
```
public class MateEntry : Placement3D
```
```

```
```
public ref class MateEntry : public Placement3D
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.MateEntry)