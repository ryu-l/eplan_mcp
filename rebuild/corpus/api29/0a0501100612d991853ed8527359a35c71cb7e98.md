# NotLockedException Class Members

NotLockedException Class Members

The following tables list the members exposed by [NotLockedException](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.NotLockedException.html).
