# PAGE_KEPP_PARTS_BY_INSERT_MACRO(Int32) Property

PAGE\_KEPP\_PARTS\_BY\_INSERT\_MACRO(Int32) Property
...
```
```
public PropertyValue PAGE_KEPP_PARTS_BY_INSERT_MACRO( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PagePropertyList~PAGE_KEPP_PARTS_BY_INSERT_MACRO(Int32))