# PlanningSegment Class Members

PlanningSegment Class Members

The following tables list the members exposed by [PlanningSegment](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.PlanningSegment.html).
