# DMPLAOBJECT_PLCADDRESS_COUNTER Property (PlanningSegmentPropertyList)

DMPLAOBJECT\_PLCADDRESS\_COUNTER Property (PlanningSegmentPropertyList)
...
| --- | --- |
| [DMPLAOBJECT\_PLCADDRESS\_COUNTER(Int32)](topic2234.html) | PLC address: Counter # 44064. |
| [DMPLAOBJECT\_PLCADDRESS\_COUNTER](topic2235.html) | PLC address: Counter # 44064. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.PlanningSegmentPropertyList~DMPLAOBJECT_PLCADDRESS_COUNTER)