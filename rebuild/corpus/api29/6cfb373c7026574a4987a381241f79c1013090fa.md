# ProjectSchemeSetting Class Members

ProjectSchemeSetting Class Members

The following tables list the members exposed by [ProjectSchemeSetting](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectSchemeSetting.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectSchemeSetting)