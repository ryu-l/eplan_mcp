# DESIGNATION_PLANT_PART(Int32) Property

DESIGNATION\_PLANT\_PART(Int32) Property
...
```
```
public PropertyValue DESIGNATION_PLANT_PART( 
   int index
) {get; set;}
```
```
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.PlanningSegmentPropertyList~DESIGNATION_PLANT_PART.html)

---

EPLAN API , 21.05.2020, Â© by EPLAN Software and Service GmbH and Co. KG. All rights reserved.

[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.PlanningSegmentPropertyList~DESIGNATION_PLANT_PART(Int32))