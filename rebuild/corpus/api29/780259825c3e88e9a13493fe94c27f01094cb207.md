# ARTICLEREF_PIECETYPE(Int32) Property

ARTICLEREF\_PIECETYPE(Int32) Property
...
```
```
public PropertyValue ARTICLEREF_PIECETYPE( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLEREF_PIECETYPE(Int32))