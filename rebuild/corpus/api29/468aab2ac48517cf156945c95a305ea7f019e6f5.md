...
```
```
public class FunctionBase : SymbolReference, IFunctionBase
```
```

```
```
public ref class FunctionBase : public SymbolReference, IFunctionBase
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionBase)