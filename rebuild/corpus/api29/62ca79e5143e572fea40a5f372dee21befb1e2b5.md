# FUNC_CIRCUITNUMBER(Int32) Property

FUNC\_CIRCUITNUMBER(Int32) Property
...
```
```
public PropertyValue FUNC_CIRCUITNUMBER( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionBasePropertyList~FUNC_CIRCUITNUMBER(Int32))