# FUNC_DT2_COLUMN(Int32) Property

FUNC\_DT2\_COLUMN(Int32) Property
...
```
```
public PropertyValue FUNC_DT2_COLUMN( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~FUNC_DT2_COLUMN(Int32))