# IVerification Interface Members

IVerification Interface Members

The following tables list the members exposed by [IVerification](Eplan.EplApi.EServicesu~Eplan.EplApi.EServices.IVerification.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.EServicesu~Eplan.EplApi.EServices.IVerification)