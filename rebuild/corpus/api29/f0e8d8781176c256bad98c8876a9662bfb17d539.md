# DESIGNATION_PRODUCT_PART(Int32) Property

DESIGNATION\_PRODUCT\_PART(Int32) Property
...
```
```
public PropertyValue DESIGNATION_PRODUCT_PART( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentTemplatePropertyList~DESIGNATION_PRODUCT_PART(Int32))