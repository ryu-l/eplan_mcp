# WRITEPROTECTED Property (InterruptionPointPropertyList)
...
| --- | --- |
| [WRITEPROTECTED(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.InterruptionPointPropertyList~WRITEPROTECTED(Int32).html) | Change protection # 3014. This property isn't indexed, and is read-only. |
| [WRITEPROTECTED](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.InterruptionPointPropertyList~WRITEPROTECTED().html) | Change protection # 3014. |
