# ARTICLE_PLCDEVICENAME_1(Int32) Property

ARTICLE\_PLCDEVICENAME\_1(Int32) Property
...
```
```
public PropertyValue ARTICLE_PLCDEVICENAME_1( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_PLCDEVICENAME_1(Int32))