# ARTICLE_LIFETIME Property (MergedArticleReferencePropertyList)

ARTICLE\_LIFETIME Property (MergedArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_LIFETIME(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLE_LIFETIME(Int32).html) | Service time # 22142. This property isn't indexed. |
| [ARTICLE\_LIFETIME](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLE_LIFETIME().html) | Service time # 22142. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLE_LIFETIME)