# MacroMissingException Class Members

MacroMissingException Class Members

The following tables list the members exposed by [MacroMissingException](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MacroMissingException.html).
