# PlaceHolder3D Class Members

PlaceHolder3D Class Members

The following tables list the members exposed by [PlaceHolder3D](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.PlaceHolder3D.html).
