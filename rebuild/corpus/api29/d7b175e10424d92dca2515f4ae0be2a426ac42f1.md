# WRITEPROTECTED Property (LocationPropertyList)
...
| --- | --- |
| [WRITEPROTECTED(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.LocationPropertyList~WRITEPROTECTED(Int32).html) | Change protection # 3014. This property isn't indexed, and is read-only. |
| [WRITEPROTECTED](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.LocationPropertyList~WRITEPROTECTED().html) | Change protection # 3014. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.LocationPropertyList~WRITEPROTECTED)