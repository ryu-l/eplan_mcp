# ARTICLE_ORDERNR Property (MergedArticleReferencePropertyList)

ARTICLE\_ORDERNR Property (MergedArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_ORDERNR(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLE_ORDERNR(Int32).html) | Order number # 22003. This property isn't indexed. |
| [ARTICLE\_ORDERNR](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLE_ORDERNR().html) | Order number # 22003. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLE_ORDERNR)