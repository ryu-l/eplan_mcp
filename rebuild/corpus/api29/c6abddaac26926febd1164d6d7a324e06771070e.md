# PLCMergedFunction Class Members

PLCMergedFunction Class Members

The following tables list the members exposed by [PLCMergedFunction](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PLCMergedFunction.html).
