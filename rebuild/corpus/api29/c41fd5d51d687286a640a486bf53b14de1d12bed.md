...
FUNC\_ARTICLE\_ORDERNR Property
...
```
```
public PropertyValue FUNC_ARTICLE_ORDERNR {get; set;}
```
```
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.PlanningSegmentPropertyList~FUNC_ARTICLE_ORDERNR.html)
