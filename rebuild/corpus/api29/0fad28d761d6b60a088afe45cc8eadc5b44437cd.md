...
```
```
public PropertyValue FUNC_BLOCK_VALUE {get; set;}
```
```
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.PlanningSegmentPropertyList~FUNC_BLOCK_VALUE.html)
