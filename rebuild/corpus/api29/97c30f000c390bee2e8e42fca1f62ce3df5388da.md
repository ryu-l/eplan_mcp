...
Collection of project messages of the last check run (See menu "Project data>Messages>Check project..." or [!!OVERLOADED\_VerifyProject\_Eplan::EplApi::HEServices:](check.html) ).
...
| Public Property | [ReuseMessages](Eplan.EplApi.EServicesu~Eplan.EplApi.EServices.PrjMessagesCollection~ReuseMessages.html) | Determines whether new message can be duplicated in collection. Default value is `false`. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.EServicesu~Eplan.EplApi.EServices.PrjMessagesCollection)