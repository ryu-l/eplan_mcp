...
The following tables list the members exposed by [Option](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Option.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Option)