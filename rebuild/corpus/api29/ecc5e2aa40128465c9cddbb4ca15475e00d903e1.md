# ImageCopyException Class Members

ImageCopyException Class Members

The following tables list the members exposed by [ImageCopyException](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ImageCopyException.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ImageCopyException)