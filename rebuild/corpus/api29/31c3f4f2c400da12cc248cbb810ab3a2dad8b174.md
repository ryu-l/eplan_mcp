# CABLE_DISTRIBUTORS(Int32) Property

CABLE\_DISTRIBUTORS(Int32) Property
...
```
```
public PropertyValue CABLE_DISTRIBUTORS( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.EObjects.CablePropertyList~CABLE_DISTRIBUTORS(Int32))