# MDPropertyAlreadyExistsException Class Members

MDPropertyAlreadyExistsException Class Members

The following tables list the members exposed by [MDPropertyAlreadyExistsException](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPropertyAlreadyExistsException.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPropertyAlreadyExistsException)