...
[Overload List](Eplan.EplApi.Baseu~Eplan.EplApi.Base.Settings~AddBoolSetting.html)

---

EPLAN API , 21.05.2020, Â© by EPLAN Software and Service GmbH and Co. KG. All rights reserved.

[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.Baseu~Eplan.EplApi.Base.Settings~AddBoolSetting(String,Boolean[],CreationFlag))