# FUNC_DT2_PAGECOUNTER(Int32) Property

FUNC\_DT2\_PAGECOUNTER(Int32) Property
...
```
```
public PropertyValue FUNC_DT2_PAGECOUNTER( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~FUNC_DT2_PAGECOUNTER(Int32))