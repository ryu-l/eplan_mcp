# DMCABBASE_ANGLE_OUT(Int32) Property

DMCABBASE\_ANGLE\_OUT(Int32) Property
...
```
```
public PropertyValue DMCABBASE_ANGLE_OUT( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Function3DPropertyList~DMCABBASE_ANGLE_OUT(Int32))