...
The following tables list the members exposed by [DocumentTypeManager](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DocumentTypeManager.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DocumentTypeManager)