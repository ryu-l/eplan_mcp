...
SYMBLIB\_COMPANY(Int32) Property
...
```
```
public PropertyValue SYMBLIB_COMPANY( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolLibraryPropertyList~SYMBLIB_COMPANY(Int32))