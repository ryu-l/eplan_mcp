...
| --- | --- |
| [FUNC\_IDENTDEVICETAGPARTS(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~FUNC_IDENTDEVICETAGPARTS(Int32).html) | Identifying DT elements # 20096. This property isn't indexed, and is read-only. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~FUNC_IDENTDEVICETAGPARTS)