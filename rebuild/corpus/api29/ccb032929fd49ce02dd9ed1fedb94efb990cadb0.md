...
FUNC\_PLCCOMMUNICATIONENTITY\_SUPPLEMENTARYFIELD07 Property
...
```
```
public PropertyValue FUNC_PLCCOMMUNICATIONENTITY_SUPPLEMENTARYFIELD07 {get; set;}
```
```
