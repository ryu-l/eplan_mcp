# CannotAddArticleException Class Members

CannotAddArticleException Class Members

The following tables list the members exposed by [CannotAddArticleException](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.CannotAddArticleException.html).
