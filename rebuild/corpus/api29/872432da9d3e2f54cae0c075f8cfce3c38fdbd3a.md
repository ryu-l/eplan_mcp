...
| --- | --- |
| [DMPLAOBJECT\_PLCADDRESS\_CONFIGURATIONPROJECT(Int32)](topic2470.html) | PLC address: Configuration project # 44048. |
| [DMPLAOBJECT\_PLCADDRESS\_CONFIGURATIONPROJECT](topic2471.html) | PLC address: Configuration project # 44048. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentTemplatePropertyList~DMPLAOBJECT_PLCADDRESS_CONFIGURATIONPROJECT)