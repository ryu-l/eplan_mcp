...
The following tables list the members exposed by [Line](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Line.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Line)