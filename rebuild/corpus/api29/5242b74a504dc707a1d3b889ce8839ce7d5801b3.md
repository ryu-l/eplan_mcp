# ProjectCantAddArticleReferenceException Class Members

ProjectCantAddArticleReferenceException Class Members

The following tables list the members exposed by [ProjectCantAddArticleReferenceException](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectCantAddArticleReferenceException.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectCantAddArticleReferenceException)