# FUNC_PLCCOMMUNICATIONENTITY_ADDRESSRANGE Property

FUNC\_PLCCOMMUNICATIONENTITY\_ADDRESSRANGE Property
...
```
```
public PropertyValue FUNC_PLCCOMMUNICATIONENTITY_ADDRESSRANGE {get; set;}
```
```
