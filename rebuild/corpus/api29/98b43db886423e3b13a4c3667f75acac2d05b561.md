# ARTICLE_MOUNTINGSITE Property (ArticlePropertyList)

ARTICLE\_MOUNTINGSITE Property (ArticlePropertyList)
...
| --- | --- |
| [ARTICLE\_MOUNTINGSITE(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_MOUNTINGSITE(Int32).html) | Mounting surface # 22022. This property isn't indexed. |
| [ARTICLE\_MOUNTINGSITE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_MOUNTINGSITE().html) | Mounting surface # 22022. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_MOUNTINGSITE)