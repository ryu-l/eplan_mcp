...
INTERRUPTIONPOINT\_SHOWALLCROSSREFERENCEDESTINATIONS(Int32) Property
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.InterruptionPointPropertyList~INTERRUPTIONPOINT_SHOWALLCROSSREFERENCEDESTINATIONS(Int32))