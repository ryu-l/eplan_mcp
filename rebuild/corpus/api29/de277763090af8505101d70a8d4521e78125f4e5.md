# SYMBOL_TRANSFORMATION_POINT Property (SymbolPropertyList)

SYMBOL\_TRANSFORMATION\_POINT Property (SymbolPropertyList)
...
| --- | --- |
| [SYMBOL\_TRANSFORMATION\_POINT(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolPropertyList~SYMBOL_TRANSFORMATION_POINT(Int32).html) | Transformation point # 16045. |
| [SYMBOL\_TRANSFORMATION\_POINT](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolPropertyList~SYMBOL_TRANSFORMATION_POINT().html) | Transformation point # 16045. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolPropertyList~SYMBOL_TRANSFORMATION_POINT)