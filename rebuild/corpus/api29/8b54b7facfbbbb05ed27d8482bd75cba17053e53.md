# DMPLAOBJECT_BUILDINGTIME_TOTAL(Int32) Property

DMPLAOBJECT\_BUILDINGTIME\_TOTAL(Int32) Property
...
```
```
public PropertyValue DMPLAOBJECT_BUILDINGTIME_TOTAL( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.PlanningSegmentPropertyList~DMPLAOBJECT_BUILDINGTIME_TOTAL(Int32))