...
Represents 3D object of cabinet in P8.
...
```
```
public class Cabinet : Function3D, Eplan.EplApi.DataModel.IArticleUser, Eplan.EplApi.DataModel.IFunctionBase
```
```

```
```
public ref class Cabinet : public Function3D, Eplan.EplApi.DataModel.IArticleUser, Eplan.EplApi.DataModel.IFunctionBase
```
```

Remarks

Cabinet itself don't have a visible 3D mesh but is assembled from elements like [Component](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Component.html) etc.
...
| Public Property | [BoundingBox](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Cabinet~BoundingBox.html) | Overridden. Returns bounding box of a Placement3D. |
...
| Public Methodstatic (Shared in Visual Basic) | [CreateTransient](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Cabinet~CreateTransient.html) | Overloaded. Creates transient and not placed Cabinet object. |
| Public Method | [Dispose()](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject~Dispose().html) | Destructor for deterministic finalization of Cabinet object. (Inherited from [Eplan.EplApi.DataModel.StorableObject](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObject.html)) |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Cabinet)