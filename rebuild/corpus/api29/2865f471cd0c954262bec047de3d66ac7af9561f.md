# ARTICLE_CUSTOM_DATA_INDEX Property (ConnectionPointsInfoPropertyList)

ARTICLE\_CUSTOM\_DATA\_INDEX Property (ConnectionPointsInfoPropertyList)
...
| --- | --- |
| [ARTICLE\_CUSTOM\_DATA\_INDEX(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPointsInfoPropertyList~ARTICLE_CUSTOM_DATA_INDEX(Int32).html) | API Parts Management Extension: Name of add-in # 22212. |
| [ARTICLE\_CUSTOM\_DATA\_INDEX](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPointsInfoPropertyList~ARTICLE_CUSTOM_DATA_INDEX().html) | API Parts Management Extension: Name of add-in # 22212. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPointsInfoPropertyList~ARTICLE_CUSTOM_DATA_INDEX)