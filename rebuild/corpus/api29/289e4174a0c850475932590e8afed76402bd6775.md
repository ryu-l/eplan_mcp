# FUNC_DEVICETYPE_MANUAL(Int32) Property

FUNC\_DEVICETYPE\_MANUAL(Int32) Property
...
```
```
public PropertyValue FUNC_DEVICETYPE_MANUAL( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionPropertyList~FUNC_DEVICETYPE_MANUAL(Int32))