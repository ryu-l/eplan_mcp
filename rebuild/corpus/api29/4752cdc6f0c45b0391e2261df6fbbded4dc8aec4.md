# PROJ_CUSTOMER(Int32) Property

PROJ\_CUSTOMER(Int32) Property

Customer # 10370. This property isn't indexed, and is read-only.
...
```
```
public PropertyValue PROJ_CUSTOMER( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectPropertyList~PROJ_CUSTOMER(Int32))