...
The following tables list the members exposed by [Properties](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Properties.html).
...
| Public Propertystatic (Shared in Visual Basic) | [AllCommunicationEntityPropIDs](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Properties~AllCommunicationEntityPropIDs.html) | Returns an array of all property ids which can exist for CommunicationEntity objects. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Properties)