# WrongSegmentDefinitionException Class Members

WrongSegmentDefinitionException Class Members

The following tables list the members exposed by [WrongSegmentDefinitionException](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.WrongSegmentDefinitionException.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.WrongSegmentDefinitionException)