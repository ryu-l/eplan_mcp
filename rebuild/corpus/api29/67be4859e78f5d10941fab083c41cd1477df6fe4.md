# Renumber Class Members

Renumber Class Members

The following tables list the members exposed by [Renumber](Eplan.EplApi.HEServicesu~Eplan.EplApi.HEServices.Renumber.html).
...
| Public Method | [PagesSupplementaryField](Eplan.EplApi.HEServicesu~Eplan.EplApi.HEServices.Renumber~PagesSupplementaryField.html) | Overloaded. Method for renumbering one of supplementary properties of pages. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.HEServicesu~Eplan.EplApi.HEServices.Renumber)