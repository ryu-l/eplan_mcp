# MDDrillingPosition Class Members

MDDrillingPosition Class Members

The following tables list the members exposed by [MDDrillingPosition](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDDrillingPosition.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDDrillingPosition)