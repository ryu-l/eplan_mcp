# TextPropertyList Class Members

TextPropertyList Class Members

The following tables list the members exposed by [TextPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextPropertyList.html).
...
| Public Property | [TEXT\_CONTENTS](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextPropertyList~TEXT_CONTENTS.html) | Overloaded. Text contents # 19201. This property isn't indexed. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.TextPropertyList)