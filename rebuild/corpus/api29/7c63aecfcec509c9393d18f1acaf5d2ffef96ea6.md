...
\* [Page](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Page.html)s matching given [PagesFilter](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PagesFilter.html). \* all [Page](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Page.html)s when filter is `null`.
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DMObjectsFinder~GetPages)