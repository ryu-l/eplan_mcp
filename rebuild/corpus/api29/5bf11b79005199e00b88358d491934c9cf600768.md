...
SYMB\_SYBMOLFUNCTIONTYPE\_NAME(Int32) Property
...
```
```
public MDPropertyValue SYMB_SYBMOLFUNCTIONTYPE_NAME( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDSymbolPropertyList~SYMB_SYBMOLFUNCTIONTYPE_NAME(Int32))