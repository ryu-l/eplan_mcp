...
| Public Method | [SetEllipse](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Arc~SetEllipse(PointD,Double,Double,Double).html) | Sets ellipse |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Arc)