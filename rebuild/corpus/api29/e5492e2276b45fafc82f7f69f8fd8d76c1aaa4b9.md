# FUNC_PLCGROUP_DATALENGTH_OUTPUTS(Int32) Property

FUNC\_PLCGROUP\_DATALENGTH\_OUTPUTS(Int32) Property
...
```
```
public PropertyValue FUNC_PLCGROUP_DATALENGTH_OUTPUTS( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionPropertyList~FUNC_PLCGROUP_DATALENGTH_OUTPUTS(Int32))