...
| --- | --- |
| [FUNC\_ARTICLE\_PARTIAL\_LENGTH\_FULL(Int32)](topic2379.html) | Subset / length (full) # 31091. |
| [FUNC\_ARTICLE\_PARTIAL\_LENGTH\_FULL](topic2380.html) | Subset / length (full) # 31091. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.PlanningSegmentPropertyList~FUNC_ARTICLE_PARTIAL_LENGTH_FULL)