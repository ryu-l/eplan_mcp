# FUNC_ARTICLE_QUANTITY_IN_PROJECT_UNIT Property (PlanningSegmentPropertyList)

FUNC\_ARTICLE\_QUANTITY\_IN\_PROJECT\_UNIT Property (PlanningSegmentPropertyList)
...
| --- | --- |
| [FUNC\_ARTICLE\_QUANTITY\_IN\_PROJECT\_UNIT(Int32)](topic2394.html) | Quantity / subset in unit of project # 31044. |
| [FUNC\_ARTICLE\_QUANTITY\_IN\_PROJECT\_UNIT](topic2395.html) | Quantity / subset in unit of project # 31044. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.PlanningSegmentPropertyList~FUNC_ARTICLE_QUANTITY_IN_PROJECT_UNIT)