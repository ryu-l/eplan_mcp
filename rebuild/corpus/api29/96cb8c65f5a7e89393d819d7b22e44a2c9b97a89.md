...
The following tables list the members exposed by [PlcIO](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PlcIO.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PlcIO)