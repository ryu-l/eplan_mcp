# PlotFrame Class Members

PlotFrame Class Members

The following tables list the members exposed by [PlotFrame](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.PlotFrame.html).
...
| Public Property | [Size](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.PlotFrame~Size.html) | Returns the exact size of the page's plot frame, takes into account page scale. The size is calculated from center of border lines. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.PlotFrame)