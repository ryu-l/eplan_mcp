# ARTICLE_ERPNR Property (ArticleReferencePropertyList)

ARTICLE\_ERPNR Property (ArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_ERPNR(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~ARTICLE_ERPNR(Int32).html) | ERP number # 22056. This property isn't indexed. |
| [ARTICLE\_ERPNR](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~ARTICLE_ERPNR().html) | ERP number # 22056. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~ARTICLE_ERPNR)