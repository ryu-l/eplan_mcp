# ARTICLEREF_PARTTYPE(Int32) Property

ARTICLEREF\_PARTTYPE(Int32) Property
...
```
```
public PropertyValue ARTICLEREF_PARTTYPE( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~ARTICLEREF_PARTTYPE(Int32))