...
The following tables list the members exposed by [Article](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Article.html).
...
| Public Method | [LoadFromMasterdata](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Article~LoadFromMasterdata.html) | Loads the article from system article database |
...
**WorkingWithParts.html**

---

EPLAN API , 21.05.2020, Â© by EPLAN Software and Service GmbH and Co. KG. All rights reserved.

[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Article)