...
| --- | --- |
| [DMPLAOBJECT\_PLCADDRESS\_COUNTER(Int32)](topic2472.html) | PLC address: Counter # 44064. |
| [DMPLAOBJECT\_PLCADDRESS\_COUNTER](topic2473.html) | PLC address: Counter # 44064. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentTemplatePropertyList~DMPLAOBJECT_PLCADDRESS_COUNTER)