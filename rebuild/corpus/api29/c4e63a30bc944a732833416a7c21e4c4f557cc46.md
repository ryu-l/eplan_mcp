...
```
```
public class Function3D : Placement3D, Eplan.EplApi.DataModel.IArticleUser, Eplan.EplApi.DataModel.IFunctionBase
```
```

```
```
public ref class Function3D : public Placement3D, Eplan.EplApi.DataModel.IArticleUser, Eplan.EplApi.DataModel.IFunctionBase
```
```
...
| Public Property | [AdditionalType](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Function3D~AdditionalType.html) | Additional Type of this Function3D. Additional Type correspond to value of "Item" list in GUI. |
...
| Public Method | [GetValidAdditionalTypes](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Function3D~GetValidAdditionalTypes.html) | Returns array of Additional Types that are valid for this Function3D. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Function3D)