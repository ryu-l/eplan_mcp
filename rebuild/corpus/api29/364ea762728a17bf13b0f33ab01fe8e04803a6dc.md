# EDITINGAREA_CRAFT Property (ArticleReferencePropertyList)

EDITINGAREA\_CRAFT Property (ArticleReferencePropertyList)
...
| --- | --- |
| [EDITINGAREA\_CRAFT(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~EDITINGAREA_CRAFT(Int32).html) | Trade (Defined working sections) # 25000. This property isn't indexed, and is read-only. |
| [EDITINGAREA\_CRAFT](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~EDITINGAREA_CRAFT().html) | Trade (Defined working sections) # 25000. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~EDITINGAREA_CRAFT)