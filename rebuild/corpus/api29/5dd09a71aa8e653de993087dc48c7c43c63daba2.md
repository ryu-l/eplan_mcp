# ARTICLEREF_FUNCTIONGROUP(Int32) Property

ARTICLEREF\_FUNCTIONGROUP(Int32) Property
...
```
```
public PropertyValue ARTICLEREF_FUNCTIONGROUP( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~ARTICLEREF_FUNCTIONGROUP(Int32))