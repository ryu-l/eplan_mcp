...
```
```
public class BusBarSystem : Function3D, Eplan.EplApi.DataModel.IArticleUser, Eplan.EplApi.DataModel.IFunctionBase
```
```

```
```
public ref class BusBarSystem : public Function3D, Eplan.EplApi.DataModel.IArticleUser, Eplan.EplApi.DataModel.IFunctionBase
```
```

Example

- [C#](#i-tab-content-29047b90-fca0-45c1-8a1f-d775bb5e567a)
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.BusBarSystem)