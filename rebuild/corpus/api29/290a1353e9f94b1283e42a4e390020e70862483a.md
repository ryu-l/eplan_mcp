...
```
```
public class SegmentPlacement : Eplan.EplApi.DataModel.SymbolReference
```
```

```
```
public ref class SegmentPlacement : public Eplan.EplApi.DataModel.SymbolReference
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentPlacement)