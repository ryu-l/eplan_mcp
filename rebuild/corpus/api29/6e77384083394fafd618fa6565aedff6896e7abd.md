...
| --- | --- |
| [DMDELETEDOBJECTINFO\_OBJECTTYPE\_HIST(Int32)](topic372.html) | Deleted object (further): Type # 36606. |
| [DMDELETEDOBJECTINFO\_OBJECTTYPE\_HIST](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DeletedObjectInfoPropertyList~DMDELETEDOBJECTINFO_OBJECTTYPE_HIST().html) | Deleted object (further): Type # 36606. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DeletedObjectInfoPropertyList~DMDELETEDOBJECTINFO_OBJECTTYPE_HIST)