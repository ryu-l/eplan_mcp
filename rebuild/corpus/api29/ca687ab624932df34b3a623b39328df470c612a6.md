...
```
```
public class Duct : BarBase, Eplan.EplApi.DataModel.IArticleUser, Eplan.EplApi.DataModel.IFunctionBase
```
```

```
```
public ref class Duct : public BarBase, Eplan.EplApi.DataModel.IArticleUser, Eplan.EplApi.DataModel.IFunctionBase
```
```
...
| Public Property | [Length](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Duct~Length.html) | Overridden. Returns length of this object. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Duct)