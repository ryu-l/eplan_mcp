...
```
```
public class NetDefinitionPoint : PotentialDefinition
```
```

```
```
public ref class NetDefinitionPoint : public PotentialDefinition
```
```
...
|  | Name | Description |
| --- | --- | --- |
| Public Method | [AddDaisyChain](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.NetDefinitionPoint~AddDaisyChain.html) | Adds new connections to NetDefinitionPoint.Each new connection is made from two consecutive PinBase objects |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.NetDefinitionPoint)