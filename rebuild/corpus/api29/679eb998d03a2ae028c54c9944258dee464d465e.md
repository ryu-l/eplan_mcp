# IFunctionVerification Interface Members

IFunctionVerification Interface Members

The following tables list the members exposed by [IFunctionVerification](Eplan.EplApi.EServicesu~Eplan.EplApi.EServices.IFunctionVerification.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.EServicesu~Eplan.EplApi.EServices.IFunctionVerification)