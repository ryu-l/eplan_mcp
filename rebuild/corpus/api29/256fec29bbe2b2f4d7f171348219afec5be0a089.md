# Property(GraphicalPlacement,Int32) Property
...
new property PropertyValue^ Property {
   PropertyValue^ get(Properties.GraphicalPlacement id, int index);
   void set (Properties.GraphicalPlacement id, int index, PropertyValue^ value);
}
```
```
...
*index*
:   Index of the GraphicalPlacement's property
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.GraphicalPlacementPropertyList~Property(GraphicalPlacement,Int32))