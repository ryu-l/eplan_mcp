# IncompatibleDatabaseException Class Members

IncompatibleDatabaseException Class Members

The following tables list the members exposed by [IncompatibleDatabaseException](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.IncompatibleDatabaseException.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.IncompatibleDatabaseException)