# MergedFunctionPropertyList Class Members

MergedFunctionPropertyList Class Members

The following tables list the members exposed by [MergedFunctionPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedFunctionPropertyList.html).
