...
ARTICLE\_SUBCRAFT\_PROCESS Property
...
```
```
public MDPropertyValue ARTICLE_SUBCRAFT_PROCESS {get; set;}
```
```
...
[Overload List](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_SUBCRAFT_PROCESS.html)
