# DESIGNATION_FUNCTIONALASSIGNMENT_PART(Int32) Property

DESIGNATION\_FUNCTIONALASSIGNMENT\_PART(Int32) Property
...
```
```
public PropertyValue DESIGNATION_FUNCTIONALASSIGNMENT_PART( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentTemplatePropertyList~DESIGNATION_FUNCTIONALASSIGNMENT_PART(Int32))