# FUNC_DISTRIBUTED_TERMINALINDEX Property (FunctionPropertyList)

FUNC\_DISTRIBUTED\_TERMINALINDEX Property (FunctionPropertyList)
...
| --- | --- |
| [FUNC\_DISTRIBUTED\_TERMINALINDEX(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionPropertyList~FUNC_DISTRIBUTED_TERMINALINDEX(Int32).html) | Distributed terminal index # 20223. This property isn't indexed. |
| [FUNC\_DISTRIBUTED\_TERMINALINDEX](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionPropertyList~FUNC_DISTRIBUTED_TERMINALINDEX().html) | Distributed terminal index # 20223. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionPropertyList~FUNC_DISTRIBUTED_TERMINALINDEX)