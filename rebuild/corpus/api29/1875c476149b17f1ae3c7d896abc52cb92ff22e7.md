...
```
```
public class MacroBox : SymbolReference
```
```

```
```
public ref class MacroBox : public SymbolReference
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MacroBox)