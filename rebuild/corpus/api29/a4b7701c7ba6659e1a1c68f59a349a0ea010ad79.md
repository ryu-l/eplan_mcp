...
| --- | --- |
| [ExportAssignmentList](topic2741.html) | Exports PLC assignment lists |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.HEServicesu~Eplan.EplApi.HEServices.PlcService~ExportAssignmentList)