# FUNC_DT2_FUNCTIONCODE(Int32) Property

FUNC\_DT2\_FUNCTIONCODE(Int32) Property
...
```
```
public PropertyValue FUNC_DT2_FUNCTIONCODE( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~FUNC_DT2_FUNCTIONCODE(Int32))