...
public SegmentTemplatesFilter( 
   ref SegmentTemplatesFilter rOther
)
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.SegmentTemplatesFilter~_ctor(SegmentTemplatesFilter))