...
| --- | --- |
| [ARTICLE\_PIPECLASS(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~ARTICLE_PIPECLASS(Int32).html) | Pipe class # 22224. This property isn't indexed. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~ARTICLE_PIPECLASS)