...
This class allows user to search the [Project](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Project.html). It defines a set of methods for retrieving different API objects. If user wants to get result objects matching a conditions, he/she should use filters.
...
- [C#](#i-tab-content-46e8d7a0-df06-4c40-b25e-1c174091c39d)

```
Project proj;//a valid project
Page p;//a valid page object

DMObjectsFinder objFinder = new DMObjectsFinder(proj);

//now we have all Functions in the project proj
Function[] functions = objFinder.GetFunctions(null);

FunctionsFilter ff = new FunctionFilters();
