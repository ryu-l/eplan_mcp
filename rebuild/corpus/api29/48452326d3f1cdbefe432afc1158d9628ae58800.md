# CONNECTION_FULLLOCATION_AUTOMATIC(Int32) Property

CONNECTION\_FULLLOCATION\_AUTOMATIC(Int32) Property
...
```
```
public PropertyValue CONNECTION_FULLLOCATION_AUTOMATIC( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~CONNECTION_FULLLOCATION_AUTOMATIC(Int32))