# NoPropertyListException Class Members

NoPropertyListException Class Members

The following tables list the members exposed by [NoPropertyListException](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.NoPropertyListException.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.NoPropertyListException)