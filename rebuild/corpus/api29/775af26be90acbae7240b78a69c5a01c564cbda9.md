# DMPLAOBJECT_GMP_RELEVANT Property (PlanningSegmentPropertyList)

DMPLAOBJECT\_GMP\_RELEVANT Property (PlanningSegmentPropertyList)
...
| --- | --- |
| [DMPLAOBJECT\_GMP\_RELEVANT(Int32)](topic2213.html) | GMP-relevant # 44061. This property isn't indexed. |
| [DMPLAOBJECT\_GMP\_RELEVANT](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.PlanningSegmentPropertyList~DMPLAOBJECT_GMP_RELEVANT().html) | GMP-relevant # 44061. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.PlanningSegmentPropertyList~DMPLAOBJECT_GMP_RELEVANT)