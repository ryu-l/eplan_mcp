# InternalQueryException Class Members

InternalQueryException Class Members

The following tables list the members exposed by [InternalQueryException](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.InternalQueryException.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.InternalQueryException)