# CONNECTION_PRODUCT_AUTOMATIC(Int32) Property

CONNECTION\_PRODUCT\_AUTOMATIC(Int32) Property
...
```
```
public PropertyValue CONNECTION_PRODUCT_AUTOMATIC( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~CONNECTION_PRODUCT_AUTOMATIC(Int32))