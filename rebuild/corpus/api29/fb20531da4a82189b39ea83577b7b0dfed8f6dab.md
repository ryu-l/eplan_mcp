...
| **Eplan.EplApi.HEServices.Exceptions.InvalidConverter** | Thrown when given parameter  `fileFormat`  isn't valid converter or such conversion doesn't exist at all. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.HEServicesu~Eplan.EplApi.HEServices.DeviceService~ImportDeviceList(String,String,Format))