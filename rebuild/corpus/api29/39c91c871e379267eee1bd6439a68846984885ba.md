# ConnectionPointsInfo Class Members

ConnectionPointsInfo Class Members

The following tables list the members exposed by [ConnectionPointsInfo](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPointsInfo.html).
