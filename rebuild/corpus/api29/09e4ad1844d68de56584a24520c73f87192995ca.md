# MDInvalidTimeValueException Class Members

MDInvalidTimeValueException Class Members

The following tables list the members exposed by [MDInvalidTimeValueException](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDInvalidTimeValueException.html).
