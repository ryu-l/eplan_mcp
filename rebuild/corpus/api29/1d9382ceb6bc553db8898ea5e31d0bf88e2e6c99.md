# PermissionException Class Members

PermissionException Class Members

The following tables list the members exposed by [PermissionException](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PermissionException.html).
