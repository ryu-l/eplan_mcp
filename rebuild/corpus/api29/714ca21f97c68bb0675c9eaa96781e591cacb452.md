...
FUNCTION3D\_ROUTING\_CONNECTIONFILTER(Int32) Property
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Placement3DPropertyList~FUNCTION3D_ROUTING_CONNECTIONFILTER(Int32))