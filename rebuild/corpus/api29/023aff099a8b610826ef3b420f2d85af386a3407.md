# SymbolReference Class Members

SymbolReference Class Members

The following tables list the members exposed by [SymbolReference](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.SymbolReference.html).
