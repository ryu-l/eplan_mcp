# OperationCanceledException Class Members

OperationCanceledException Class Members

The following tables list the members exposed by [OperationCanceledException](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.OperationCanceledException.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.OperationCanceledException)