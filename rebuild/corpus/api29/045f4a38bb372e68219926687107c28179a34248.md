# CDP_CON_DT(Int32) Property

CDP\_CON\_DT(Int32) Property

Associated connections: Device tag (identifying) # 31027. This property isn't indexed, and is read-only.
...
```
```
public PropertyValue CDP_CON_DT( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionDefinitionPointPropertyList~CDP_CON_DT(Int32))