...
| --- | --- |
| [DMPLAOBJECT\_PLCADDRESS\_STATION(Int32)](topic2246.html) | PLC address: Workstation # 44047. |
| [DMPLAOBJECT\_PLCADDRESS\_STATION](topic2247.html) | PLC address: Workstation # 44047. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.PlanningSegmentPropertyList~DMPLAOBJECT_PLCADDRESS_STATION)