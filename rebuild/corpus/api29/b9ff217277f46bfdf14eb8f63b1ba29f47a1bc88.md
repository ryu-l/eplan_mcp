# MDEmptyPropertyException Class Members

MDEmptyPropertyException Class Members

The following tables list the members exposed by [MDEmptyPropertyException](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDEmptyPropertyException.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDEmptyPropertyException)