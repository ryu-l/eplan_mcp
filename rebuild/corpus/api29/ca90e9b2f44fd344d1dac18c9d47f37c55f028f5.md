# PLUGSTRIP_COUNTOFINTERNALOBJECTS(Int32) Property

PLUGSTRIP\_COUNTOFINTERNALOBJECTS(Int32) Property
...
```
```
public PropertyValue PLUGSTRIP_COUNTOFINTERNALOBJECTS( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.EObjects.PlugStripPropertyList~PLUGSTRIP_COUNTOFINTERNALOBJECTS(Int32))