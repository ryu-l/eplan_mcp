# ARTICLE_NOTE Property (ArticlePropertyList)

ARTICLE\_NOTE Property (ArticlePropertyList)
...
| --- | --- |
| [ARTICLE\_NOTE(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_NOTE(Int32).html) | Description # 22009. This property isn't indexed. |
| [ARTICLE\_NOTE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_NOTE().html) | Description # 22009. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_NOTE)