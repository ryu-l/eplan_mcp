...
SYMB\_LASTAUTOMODIFICATIONDATE(Int32) Property
...
```
```
public PropertyValue SYMB_LASTAUTOMODIFICATIONDATE( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolPropertyList~SYMB_LASTAUTOMODIFICATIONDATE(Int32))