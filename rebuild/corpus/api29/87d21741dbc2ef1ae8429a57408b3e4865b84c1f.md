...
```
```
public MDPropertyValue SYMBLIB_FUNCTYPEERROR {get; set;}
```
```
...
[Overload List](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDSymbolLibraryPropertyList~SYMBLIB_FUNCTYPEERROR.html)
