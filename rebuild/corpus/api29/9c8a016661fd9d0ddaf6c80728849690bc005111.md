# Property Property (ConnectionPointsInfoPropertyList)
...
| --- | --- |
| [Property(ConnectionPointsInfo,Int32)](topic291.html) | Method used by operator[] in order to access indexed properties. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPointsInfoPropertyList~Property)