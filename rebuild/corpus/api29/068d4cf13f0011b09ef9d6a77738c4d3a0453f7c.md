...
The following tables list the members exposed by [Image](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Image.html).
...
| Public Method | [CreateTransient](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Image~CreateTransient.html) | Overridden. Creates transient and not placed Image object. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Image)