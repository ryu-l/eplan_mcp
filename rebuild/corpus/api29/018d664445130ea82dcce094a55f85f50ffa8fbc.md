# MacroEntry Class Members

MacroEntry Class Members

The following tables list the members exposed by [MacroEntry](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MacroEntry.html).
...
| Public Property | [RelatedObject](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MacroEntry~RelatedObject.html) | Gets related object, i.e. the same as under menu point 'Go to Graphic' |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MacroEntry)