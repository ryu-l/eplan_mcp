# IncorrectSymbolTypeException Class Members

IncorrectSymbolTypeException Class Members

The following tables list the members exposed by [IncorrectSymbolTypeException](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.IncorrectSymbolTypeException.html).
