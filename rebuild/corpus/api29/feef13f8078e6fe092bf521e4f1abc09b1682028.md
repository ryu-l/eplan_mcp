...
SYMB\_PROPERTYINSTANCESET Property
...
```
```
public MDPropertyValue SYMB_PROPERTYINSTANCESET {get; set;}
```
```
...
[Overload List](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDSymbolPropertyList~SYMB_PROPERTYINSTANCESET.html)
