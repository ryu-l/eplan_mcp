# MDObjectNotCreatedException Class Members

MDObjectNotCreatedException Class Members

The following tables list the members exposed by [MDObjectNotCreatedException](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDObjectNotCreatedException.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDObjectNotCreatedException)