# FUNC_PLCGROUP_STARTADDRESS_2_INPUTS(Int32) Property

FUNC\_PLCGROUP\_STARTADDRESS\_2\_INPUTS(Int32) Property
...
```
```
public PropertyValue FUNC_PLCGROUP_STARTADDRESS_2_INPUTS( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionPropertyList~FUNC_PLCGROUP_STARTADDRESS_2_INPUTS(Int32))