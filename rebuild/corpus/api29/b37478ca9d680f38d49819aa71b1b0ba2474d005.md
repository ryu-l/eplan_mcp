# ARTICLE_SPARE Property (ArticleReferencePropertyList)

ARTICLE\_SPARE Property (ArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_SPARE(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~ARTICLE_SPARE(Int32).html) | Spare part # 22140. This property isn't indexed. |
| [ARTICLE\_SPARE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~ARTICLE_SPARE().html) | Spare part # 22140. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~ARTICLE_SPARE)