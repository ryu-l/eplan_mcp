# PART_TERMINAL_TYPEOFTERMINAL_DEFAULT Property (ConnectionPointsInfoPropertyList)

PART\_TERMINAL\_TYPEOFTERMINAL\_DEFAULT Property (ConnectionPointsInfoPropertyList)
...
| --- | --- |
| [PART\_TERMINAL\_TYPEOFTERMINAL\_DEFAULT(Int32)](topic289.html) | Connection category (default) # 22968. This property isn't indexed. |
| [PART\_TERMINAL\_TYPEOFTERMINAL\_DEFAULT](topic290.html) | Connection category (default) # 22968. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPointsInfoPropertyList~PART_TERMINAL_TYPEOFTERMINAL_DEFAULT)