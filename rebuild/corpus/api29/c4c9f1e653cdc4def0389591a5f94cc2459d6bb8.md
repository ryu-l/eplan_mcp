# MDIncorrectNameFormatException Class Members

MDIncorrectNameFormatException Class Members

The following tables list the members exposed by [MDIncorrectNameFormatException](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDIncorrectNameFormatException.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDIncorrectNameFormatException)