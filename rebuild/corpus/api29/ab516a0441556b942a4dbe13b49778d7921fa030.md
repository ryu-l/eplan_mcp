...
| --- | --- |
| [ARTICLE\_WIDTHRATING(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionDefinitionPointPropertyList~ARTICLE_WIDTHRATING(Int32).html) | Nominal width # 22225. This property isn't indexed. |
| [ARTICLE\_WIDTHRATING](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionDefinitionPointPropertyList~ARTICLE_WIDTHRATING().html) | Nominal width # 22225. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionDefinitionPointPropertyList~ARTICLE_WIDTHRATING)