# ARTICLE_MAINTENANCE Property (ArticleReferencePropertyList)

ARTICLE\_MAINTENANCE Property (ArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_MAINTENANCE(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~ARTICLE_MAINTENANCE(Int32).html) | Lubrication / maintenance # 22141. This property isn't indexed. |
| [ARTICLE\_MAINTENANCE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~ARTICLE_MAINTENANCE().html) | Lubrication / maintenance # 22141. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~ARTICLE_MAINTENANCE)