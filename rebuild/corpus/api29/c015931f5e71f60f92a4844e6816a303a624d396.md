# AdditionalObjectsFilter Property (FunctionVerification)
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.EServicesu~Eplan.EplApi.EServices.FunctionVerification~AdditionalObjectsFilter)