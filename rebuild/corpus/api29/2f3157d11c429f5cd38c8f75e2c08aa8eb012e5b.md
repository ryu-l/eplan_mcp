# EplanServerData Class Members

EplanServerData Class Members

The following tables list the members exposed by [EplanServerData](Eplan.EplApi.RemoteClientu~Eplan.EplApi.RemoteClient.EplanServerData.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.RemoteClientu~Eplan.EplApi.RemoteClient.EplanServerData)