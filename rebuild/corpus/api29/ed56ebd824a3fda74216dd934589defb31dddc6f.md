# DimensionItem Class Members

DimensionItem Class Members

The following tables list the members exposed by [DimensionItem](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionItem.html).
