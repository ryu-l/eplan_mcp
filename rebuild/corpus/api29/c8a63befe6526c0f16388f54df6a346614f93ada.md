...
ARTICLE\_SUBCRAFT\_COOLINGLUBRICANT Property
...
```
```
public MDPropertyValue ARTICLE_SUBCRAFT_COOLINGLUBRICANT {get; set;}
```
```
...
[Overload List](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_SUBCRAFT_COOLINGLUBRICANT.html)
