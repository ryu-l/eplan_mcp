# SYMB_NETCONNECTING(Int32) Property

SYMB\_NETCONNECTING(Int32) Property
...
```
```
public MDPropertyValue SYMB_NETCONNECTING( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDSymbolPropertyList~SYMB_NETCONNECTING(Int32))