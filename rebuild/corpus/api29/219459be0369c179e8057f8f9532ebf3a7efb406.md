...
| Public Property | [Project](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.Symbol~Project.html) | Overridden. Returns the project the StorableObject belongs to. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.Symbol)