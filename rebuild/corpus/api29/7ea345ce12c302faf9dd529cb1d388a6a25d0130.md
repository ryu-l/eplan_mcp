# WindowMacro Class Members

WindowMacro Class Members

The following tables list the members exposed by [WindowMacro](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.WindowMacro.html).
