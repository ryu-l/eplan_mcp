# SymbolVariantNotFoundException Class Members

SymbolVariantNotFoundException Class Members

The following tables list the members exposed by [SymbolVariantNotFoundException](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.SymbolVariantNotFoundException.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.SymbolVariantNotFoundException)