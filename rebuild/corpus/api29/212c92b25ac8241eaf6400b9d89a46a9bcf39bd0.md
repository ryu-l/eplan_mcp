# FUNC_ARTICLE_ADDITIONAL_BOOLFIELD Property (ConnectionPropertyList)

FUNC\_ARTICLE\_ADDITIONAL\_BOOLFIELD Property (ConnectionPropertyList)
...
| --- | --- |
| [FUNC\_ARTICLE\_ADDITIONAL\_BOOLFIELD(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~FUNC_ARTICLE_ADDITIONAL_BOOLFIELD(Int32).html) | Suppl. field: Yes / No # 20916. |
| [FUNC\_ARTICLE\_ADDITIONAL\_BOOLFIELD](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~FUNC_ARTICLE_ADDITIONAL_BOOLFIELD().html) | Suppl. field: Yes / No # 20916. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~FUNC_ARTICLE_ADDITIONAL_BOOLFIELD)