# CONNECTION_FULLUSERDEFINED_AUTOMATIC(Int32) Property

CONNECTION\_FULLUSERDEFINED\_AUTOMATIC(Int32) Property
...
```
```
public PropertyValue CONNECTION_FULLUSERDEFINED_AUTOMATIC( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~CONNECTION_FULLUSERDEFINED_AUTOMATIC(Int32))