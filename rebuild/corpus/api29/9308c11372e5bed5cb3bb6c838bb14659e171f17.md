# CONNECTION_FULLFUNCTIONALASSIGNMENT_AUTOMATIC(Int32) Property

CONNECTION\_FULLFUNCTIONALASSIGNMENT\_AUTOMATIC(Int32) Property
...
```
```
public PropertyValue CONNECTION_FULLFUNCTIONALASSIGNMENT_AUTOMATIC( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~CONNECTION_FULLFUNCTIONALASSIGNMENT_AUTOMATIC(Int32))