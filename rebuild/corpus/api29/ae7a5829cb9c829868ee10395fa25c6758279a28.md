# FUNC_ARTICLE_PARTIAL_LENGTH Property (FunctionPropertyList)

FUNC\_ARTICLE\_PARTIAL\_LENGTH Property (FunctionPropertyList)
...
| --- | --- |
| [FUNC\_ARTICLE\_PARTIAL\_LENGTH(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionPropertyList~FUNC_ARTICLE_PARTIAL_LENGTH(Int32).html) | Subset / length # 31008. |
| [FUNC\_ARTICLE\_PARTIAL\_LENGTH](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionPropertyList~FUNC_ARTICLE_PARTIAL_LENGTH().html) | Subset / length # 31008. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionPropertyList~FUNC_ARTICLE_PARTIAL_LENGTH)