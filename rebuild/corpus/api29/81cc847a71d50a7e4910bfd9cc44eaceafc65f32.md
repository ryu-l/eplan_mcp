...
```
```
public MDPropertyValue FUNC_CATEGORY_GROUP_ID( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDSymbolPropertyList~FUNC_CATEGORY_GROUP_ID(Int32))