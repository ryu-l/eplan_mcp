...
| --- | --- |
| [MACROBOX\_USAGE(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MacroEntryPropertyList~MACROBOX_USAGE(Int32).html) | Macro: Type of usage # 23011. This property isn't indexed. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MacroEntryPropertyList~MACROBOX_USAGE)