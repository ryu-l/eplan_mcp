# EDITINGAREA_CRAFT Property (ConnectionPropertyList)

EDITINGAREA\_CRAFT Property (ConnectionPropertyList)
...
| --- | --- |
| [EDITINGAREA\_CRAFT(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~EDITINGAREA_CRAFT(Int32).html) | Trade (Defined working sections) # 25000. This property isn't indexed, and is read-only. |
| [EDITINGAREA\_CRAFT](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~EDITINGAREA_CRAFT().html) | Trade (Defined working sections) # 25000. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~EDITINGAREA_CRAFT)