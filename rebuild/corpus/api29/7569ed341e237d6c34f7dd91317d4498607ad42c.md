# MasterDataException Class Members

MasterDataException Class Members

The following tables list the members exposed by [MasterDataException](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MasterDataException.html).
