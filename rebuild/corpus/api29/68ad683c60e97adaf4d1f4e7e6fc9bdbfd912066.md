# ProjectCopyException Class Members

ProjectCopyException Class Members

The following tables list the members exposed by [ProjectCopyException](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectCopyException.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectCopyException)