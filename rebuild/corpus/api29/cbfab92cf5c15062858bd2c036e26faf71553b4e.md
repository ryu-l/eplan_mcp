# Spline Class Members

Spline Class Members

The following tables list the members exposed by [Spline](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Spline.html).
...
| Public Methodstatic (Shared in Visual Basic) | [Create](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Spline~Create.html) | Creates a Spline object. |
| Public Method | [CreateTransient](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Spline~CreateTransient.html) | Overridden. Creates transient and not placed Spline object. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Spline)