# SplinePropertyList Class Members

SplinePropertyList Class Members

The following tables list the members exposed by [SplinePropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.SplinePropertyList.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.SplinePropertyList)