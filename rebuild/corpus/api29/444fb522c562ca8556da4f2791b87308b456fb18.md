...
ARTICLE\_TRIGGERCURRENT(Int32) Property
...
```
```
public PropertyValue ARTICLE_TRIGGERCURRENT( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_TRIGGERCURRENT(Int32))