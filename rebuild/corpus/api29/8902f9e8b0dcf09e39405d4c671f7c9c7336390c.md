# FUNC_TYPE(Int32) Property

FUNC\_TYPE(Int32) Property
...
```
```
public PropertyValue FUNC_TYPE( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~FUNC_TYPE(Int32))