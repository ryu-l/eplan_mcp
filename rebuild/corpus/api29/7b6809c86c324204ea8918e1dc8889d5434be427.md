# DMPLAOBJECT_PLANNINGTIME_TOTAL(Int32) Property

DMPLAOBJECT\_PLANNINGTIME\_TOTAL(Int32) Property
...
```
```
public PropertyValue DMPLAOBJECT_PLANNINGTIME_TOTAL( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.PlanningSegmentPropertyList~DMPLAOBJECT_PLANNINGTIME_TOTAL(Int32))