...
| --- | --- |
| [WRITEPROTECTED(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.PlanningSegmentPropertyList~WRITEPROTECTED(Int32).html) | Change protection # 3014. This property isn't indexed, and is read-only. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.PlanningSegmentPropertyList~WRITEPROTECTED)