...
PART\_TERMINAL\_ADDITIONALLENGTHDEFAULT(Int32) Property
...
```
```
public PropertyValue PART_TERMINAL_ADDITIONALLENGTHDEFAULT( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPointsInfoPropertyList~PART_TERMINAL_ADDITIONALLENGTHDEFAULT(Int32))