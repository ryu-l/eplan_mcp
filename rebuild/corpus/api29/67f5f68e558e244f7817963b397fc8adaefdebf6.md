# CDP_CON_AUTO_WIRECROSSSECTION_UNIT(Int32) Property

CDP\_CON\_AUTO\_WIRECROSSSECTION\_UNIT(Int32) Property
...
```
```
public PropertyValue CDP_CON_AUTO_WIRECROSSSECTION_UNIT( 
   int index
) {get; set;}
```
```
...
[Overload List](topic208.html)

---

EPLAN API , 21.05.2020, Â© by EPLAN Software and Service GmbH and Co. KG. All rights reserved.

[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionDefinitionPointPropertyList~CDP_CON_AUTO_WIRECROSSSECTION_UNIT(Int32))