...
FUNC\_ARTICLE\_DESCR1 Property
...
```
```
public PropertyValue FUNC_ARTICLE_DESCR1 {get; set;}
```
```
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.PlanningSegmentPropertyList~FUNC_ARTICLE_DESCR1.html)
