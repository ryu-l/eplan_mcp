...
- [C#](#i-tab-content-60f26747-5d36-4d0a-af6c-01ce845981bf)
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Cabinet~Create(Project,String,String,Int32,List{Placement3D}))