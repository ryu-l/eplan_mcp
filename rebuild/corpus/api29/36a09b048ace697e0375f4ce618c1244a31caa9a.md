...
```
```
public class Group : Placement
```
```

```
```
public ref class Group : public Placement
```
```
...
| Public Method | [Move](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Group~Move.html) | Move all [Placement](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Placement.html)s in a group by a [Eplan.EplApi.Base.PointD](Eplan.EplApi.Baseu~Eplan.EplApi.Base.PointD.html) given as param. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Group)