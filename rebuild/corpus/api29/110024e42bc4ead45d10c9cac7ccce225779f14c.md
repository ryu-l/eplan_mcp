# FUNC_CRAFTCODE Property (MergedArticleReferencePropertyList)

FUNC\_CRAFTCODE Property (MergedArticleReferencePropertyList)
...
| --- | --- |
| [FUNC\_CRAFTCODE(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~FUNC_CRAFTCODE(Int32).html) | Media code # 20316. This property isn't indexed, and is read-only. |
| [FUNC\_CRAFTCODE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~FUNC_CRAFTCODE().html) | Media code # 20316. |
