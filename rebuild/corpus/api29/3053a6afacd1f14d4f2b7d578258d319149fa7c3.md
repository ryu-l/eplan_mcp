# FUNC_CONTACTIMAGETEXT(Int32) Property

FUNC\_CONTACTIMAGETEXT(Int32) Property
...
```
```
public PropertyValue FUNC_CONTACTIMAGETEXT( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Placement3DPropertyList~FUNC_CONTACTIMAGETEXT(Int32))