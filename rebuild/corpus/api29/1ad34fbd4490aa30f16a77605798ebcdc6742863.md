...
| --- | --- |
| [ARTICLE\_PLCGROUP\_DATALENGTH\_OUTPUTS(Int32)](topic2922.html) | PLC device: Data length (outputs) # 20573. This property isn't indexed. |
| [ARTICLE\_PLCGROUP\_DATALENGTH\_OUTPUTS](topic2923.html) | PLC device: Data length (outputs) # 20573. |
