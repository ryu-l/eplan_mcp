# DeviceGroup Class Members

DeviceGroup Class Members

The following tables list the members exposed by [DeviceGroup](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DeviceGroup.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DeviceGroup)