# MDInvalidArgumentException Class Members

MDInvalidArgumentException Class Members

The following tables list the members exposed by [MDInvalidArgumentException](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDInvalidArgumentException.html).
