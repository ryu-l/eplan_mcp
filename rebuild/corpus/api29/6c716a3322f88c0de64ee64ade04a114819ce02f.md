# ProjectOpenException Class Members

ProjectOpenException Class Members

The following tables list the members exposed by [ProjectOpenException](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectOpenException.html).
