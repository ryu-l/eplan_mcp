# ARTICLE_CUSTOM_DATA_INDEX Property (MDPartsDatabaseItemPropertyList)

ARTICLE\_CUSTOM\_DATA\_INDEX Property (MDPartsDatabaseItemPropertyList)
...
| --- | --- |
| [ARTICLE\_CUSTOM\_DATA\_INDEX(Int32)](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_CUSTOM_DATA_INDEX(Int32).html) | API Parts Management Extension: Name of add-in # 22212. |
| [ARTICLE\_CUSTOM\_DATA\_INDEX](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_CUSTOM_DATA_INDEX().html) | API Parts Management Extension: Name of add-in # 22212. |
