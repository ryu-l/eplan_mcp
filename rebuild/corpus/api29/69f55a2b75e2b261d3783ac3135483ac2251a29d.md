...
| Public Method | [AddBoolSetting](Eplan.EplApi.Baseu~Eplan.EplApi.Base.SettingNode~AddBoolSetting(String,Boolean[],CreationFlag).html) | Defines a new setting for a boolean value. |
...
| Public Method | [AddDoubleSetting](Eplan.EplApi.Baseu~Eplan.EplApi.Base.SettingNode~AddDoubleSetting(String,Double[],Range[],CreationFlag).html) | Defines a new setting for a double value. |
...
| Public Method | [AddMultiLangStringSetting](topic5.html) | Defines a new setting for a multilanguage string value. |
...
| Public Method | [AddNumericSetting](Eplan.EplApi.Baseu~Eplan.EplApi.Base.SettingNode~AddNumericSetting(String,Int32[],Range[],CreationFlag).html) | Defines a new setting for a numeric value. |
...
| Public Method | [AddStringSetting](Eplan.EplApi.Baseu~Eplan.EplApi.Base.SettingNode~AddStringSetting(String,String[],String[],CreationFlag).html) | Defines a new setting for a string value. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.Baseu~Eplan.EplApi.Base.SettingNode)