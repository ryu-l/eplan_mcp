...
ARTICLE\_SUBCRAFT\_ELECTRICAL Property
...
```
```
public MDPropertyValue ARTICLE_SUBCRAFT_ELECTRICAL {get; set;}
```
```
...
[Overload List](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_SUBCRAFT_ELECTRICAL.html)
