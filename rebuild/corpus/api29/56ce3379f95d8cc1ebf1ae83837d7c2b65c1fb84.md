# DimensionGroup Class Members

DimensionGroup Class Members

The following tables list the members exposed by [DimensionGroup](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DimensionGroup.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DimensionGroup)