# SegmentTemplate Class Members

SegmentTemplate Class Members

The following tables list the members exposed by [SegmentTemplate](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentTemplate.html).
...
| Public Method | [PauseWriteProtection](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentTemplate~PauseWriteProtection.html) | Temporarily disables write protection. Note that current write protection |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentTemplate)