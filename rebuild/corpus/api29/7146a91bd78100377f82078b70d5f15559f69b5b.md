...
|  | Name | Description |
| --- | --- | --- |
| Public Method | [Create](topic1042.html) | Creates a mounting line mate. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.MountingLineMate)