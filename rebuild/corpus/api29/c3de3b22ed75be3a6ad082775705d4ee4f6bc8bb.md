...
| --- | --- |
| [DMPLAOBJECT\_ANALOG\_PLCINPUT\_COUNT(Int32)](topic2179.html) | Total number of analog PLC inputs # 44030. This property isn't indexed, and is read-only. |
| [DMPLAOBJECT\_ANALOG\_PLCINPUT\_COUNT](topic2180.html) | Total number of analog PLC inputs # 44030. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.PlanningSegmentPropertyList~DMPLAOBJECT_ANALOG_PLCINPUT_COUNT)