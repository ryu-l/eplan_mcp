# FUNC_ARTICLE_PARTIAL_LENGTH_FULL Property (FunctionPropertyList)

FUNC\_ARTICLE\_PARTIAL\_LENGTH\_FULL Property (FunctionPropertyList)
...
| --- | --- |
| [FUNC\_ARTICLE\_PARTIAL\_LENGTH\_FULL(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionPropertyList~FUNC_ARTICLE_PARTIAL_LENGTH_FULL(Int32).html) | Subset / length (full) # 31091. |
| [FUNC\_ARTICLE\_PARTIAL\_LENGTH\_FULL](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionPropertyList~FUNC_ARTICLE_PARTIAL_LENGTH_FULL().html) | Subset / length (full) # 31091. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionPropertyList~FUNC_ARTICLE_PARTIAL_LENGTH_FULL)