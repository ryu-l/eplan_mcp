# ARTICLEREF_FUNCTIONGROUP Property (MergedArticleReferencePropertyList)

ARTICLEREF\_FUNCTIONGROUP Property (MergedArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLEREF\_FUNCTIONGROUP(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLEREF_FUNCTIONGROUP(Int32).html) | Function group # 20489. This property isn't indexed. |
| [ARTICLEREF\_FUNCTIONGROUP](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLEREF_FUNCTIONGROUP().html) | Function group # 20489. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLEREF_FUNCTIONGROUP)