# FUNC_PLCCPU_NAME Property (Placement3DPropertyList)

FUNC\_PLCCPU\_NAME Property (Placement3DPropertyList)
...
| --- | --- |
| [FUNC\_PLCCPU\_NAME(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Placement3DPropertyList~FUNC_PLCCPU_NAME(Int32).html) | CPU: Name # 20253. |
| [FUNC\_PLCCPU\_NAME](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Placement3DPropertyList~FUNC_PLCCPU_NAME().html) | CPU: Name # 20253. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Placement3DPropertyList~FUNC_PLCCPU_NAME)