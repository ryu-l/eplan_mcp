# FUNC_IDENTNAMEPARTS Property (FunctionBasePropertyList)

FUNC\_IDENTNAMEPARTS Property (FunctionBasePropertyList)
...
| --- | --- |
| [FUNC\_IDENTNAMEPARTS(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionBasePropertyList~FUNC_IDENTNAMEPARTS(Int32).html) | Identifying name elements # 20095. This property isn't indexed, and is read-only. |
| [FUNC\_IDENTNAMEPARTS](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionBasePropertyList~FUNC_IDENTNAMEPARTS().html) | Identifying name elements # 20095. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionBasePropertyList~FUNC_IDENTNAMEPARTS)