...
CONNECTION\_FULLPLACEOFINSTALLATION\_AUTOMATIC(Int32) Property
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~CONNECTION_FULLPLACEOFINSTALLATION_AUTOMATIC(Int32))