...
- [C#](#i-tab-content-4d37e286-6e4c-4796-892d-3fbbc3e659c0)
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [SegmentPlacementPropertyList Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentPlacementPropertyList~_ctor.html) | Overloaded. |
...
| Public Property | [FUNC\_CROSSREFERENCE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentPlacementPropertyList~FUNC_CROSSREFERENCE.html) | Overloaded. Cross-reference (main / aux. function) # 20300. This property isn't indexed, and is read-only. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentPlacementPropertyList)