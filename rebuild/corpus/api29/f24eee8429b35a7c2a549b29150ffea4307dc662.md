# DMPLAOBJECT_SAFETY_RELEVANT(Int32) Property

DMPLAOBJECT\_SAFETY\_RELEVANT(Int32) Property
...
```
```
public PropertyValue DMPLAOBJECT_SAFETY_RELEVANT( 
   int index
) {get; set;}
```
```
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.PlanningSegmentPropertyList~DMPLAOBJECT_SAFETY_RELEVANT.html)

---

EPLAN API , 21.05.2020, Â© by EPLAN Software and Service GmbH and Co. KG. All rights reserved.

[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.PlanningSegmentPropertyList~DMPLAOBJECT_SAFETY_RELEVANT(Int32))