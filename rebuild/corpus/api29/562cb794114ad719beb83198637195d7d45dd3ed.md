...
```
```
public void AddStaticPopupMenuItem( 
   string strMenuIdentifier,
   MultiLangString strPopupText,
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.Guiu~Eplan.EplApi.Gui.Menu~AddStaticPopupMenuItem)