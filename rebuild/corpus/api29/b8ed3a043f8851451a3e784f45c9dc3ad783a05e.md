...
- [C#](#i-tab-content-c5986bfd-f561-4a0a-81b3-046facd4b5cb)
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Topology.Segment~Create(Project,SymbolReference,SymbolReference))