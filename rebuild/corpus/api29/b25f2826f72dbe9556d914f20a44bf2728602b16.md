...
ARTICLE\_PLCGROUP\_DATALENGTH\_OUTPUTS\_4(Int32) Property
...
```
```
public MDPropertyValue ARTICLE_PLCGROUP_DATALENGTH_OUTPUTS_4( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_PLCGROUP_DATALENGTH_OUTPUTS_4(Int32))