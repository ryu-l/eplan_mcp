...
SYMBLIB\_GRAPHICERROR Property
...
```
```
public MDPropertyValue SYMBLIB_GRAPHICERROR {get; set;}
```
```
...
[Overload List](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDSymbolLibraryPropertyList~SYMBLIB_GRAPHICERROR.html)
