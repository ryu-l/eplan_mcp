# NoLockingStepException Class Members

NoLockingStepException Class Members

The following tables list the members exposed by [NoLockingStepException](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.NoLockingStepException.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.NoLockingStepException)