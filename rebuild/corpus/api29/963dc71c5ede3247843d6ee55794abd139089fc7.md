...
FUNC\_PLCCOMMUNICATIONENTITY\_CONFIGURATIONPROJECT Property
...
```
```
public PropertyValue FUNC_PLCCOMMUNICATIONENTITY_CONFIGURATIONPROJECT {get; set;}
```
```
