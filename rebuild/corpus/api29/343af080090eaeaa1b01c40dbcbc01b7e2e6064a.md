# CDP_CON_WIRENUMBER(Int32) Property

CDP\_CON\_WIRENUMBER(Int32) Property
...
```
```
public PropertyValue CDP_CON_WIRENUMBER( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionDefinitionPointPropertyList~CDP_CON_WIRENUMBER(Int32))