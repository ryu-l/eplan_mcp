# DMPLAOBJECT_PLCADDRESS_SYMBOLICADDRESS_PART Property (PlanningSegmentPropertyList)

DMPLAOBJECT\_PLCADDRESS\_SYMBOLICADDRESS\_PART Property (PlanningSegmentPropertyList)
...
| --- | --- |
| [DMPLAOBJECT\_PLCADDRESS\_SYMBOLICADDRESS\_PART(Int32)](topic2255.html) | PLC address: Symbolic address (single component) # 44052. |
| [DMPLAOBJECT\_PLCADDRESS\_SYMBOLICADDRESS\_PART](topic2256.html) | PLC address: Symbolic address (single component) # 44052. |
