# IInterruptionPointVerification Interface Members

IInterruptionPointVerification Interface Members

The following tables list the members exposed by [IInterruptionPointVerification](Eplan.EplApi.EServicesu~Eplan.EplApi.EServices.IInterruptionPointVerification.html).
...
[IInterruptionPointVerification Interface](Eplan.EplApi.EServicesu~Eplan.EplApi.EServices.IInterruptionPointVerification.html)
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.EServicesu~Eplan.EplApi.EServices.IInterruptionPointVerification)