# FUNC_COMPONENTNUMBER(Int32) Property

FUNC\_COMPONENTNUMBER(Int32) Property
...
```
```
public PropertyValue FUNC_COMPONENTNUMBER( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionBasePropertyList~FUNC_COMPONENTNUMBER(Int32))