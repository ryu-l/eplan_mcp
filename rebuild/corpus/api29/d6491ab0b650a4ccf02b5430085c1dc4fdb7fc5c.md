...
DMPLAOBJECT\_PLCADDRESS\_CPU Property
...
```
```
public PropertyValue DMPLAOBJECT_PLCADDRESS_CPU {get; set;}
```
```
...
[Overload List](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentTemplatePropertyList~DMPLAOBJECT_PLCADDRESS_CPU.html)
