# SYMB_DEFAULT_ALTERNATIVE_PROPERTYSET_G(Int32) Property

SYMB\_DEFAULT\_ALTERNATIVE\_PROPERTYSET\_G(Int32) Property
...
```
```
public PropertyValue SYMB_DEFAULT_ALTERNATIVE_PROPERTYSET_G( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolPropertyList~SYMB_DEFAULT_ALTERNATIVE_PROPERTYSET_G(Int32))