# IncorrectNameFormatException Class Members

IncorrectNameFormatException Class Members

The following tables list the members exposed by [IncorrectNameFormatException](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.IncorrectNameFormatException.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.IncorrectNameFormatException)