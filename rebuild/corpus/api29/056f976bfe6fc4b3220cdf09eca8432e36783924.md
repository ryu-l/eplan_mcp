# SetBoolSetting Method (SchemeSetting)
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.Baseu~Eplan.EplApi.Base.SchemeSetting~SetBoolSetting)