...
PROJ\_BLOCKFORMAT\_FUNCTION Property
...
```
```
public PropertyValue PROJ_BLOCKFORMAT_FUNCTION {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectPropertyList~PROJ_BLOCKFORMAT_FUNCTION())