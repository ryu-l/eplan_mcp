...
| --- | --- |
| [FUNCTION\_PLCIMPORTCOMPARE\_MARKEDTOBEDELETED(Int32)](topic566.html) | Marked for deletion # 20186. This property isn't indexed. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionPropertyList~FUNCTION_PLCIMPORTCOMPARE_MARKEDTOBEDELETED)