...
DMPLAOBJECT\_SEGMENT\_ANALOG\_PLCINPUT\_COUNT(Int32) Property
...
[Overload List](topic2270.html)

---

EPLAN API , 21.05.2020, Â© by EPLAN Software and Service GmbH and Co. KG. All rights reserved.

[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.PlanningSegmentPropertyList~DMPLAOBJECT_SEGMENT_ANALOG_PLCINPUT_COUNT(Int32))