...
```
```
public class LocationBox : FunctionBase, IFunctionBase
```
```

```
```
public ref class LocationBox : public FunctionBase, IFunctionBase
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.LocationBox)