# DMPLAOBJECT_SEGMENT_DIGITAL_PLCOUTPUT_COUNT(Int32) Property

DMPLAOBJECT\_SEGMENT\_DIGITAL\_PLCOUTPUT\_COUNT(Int32) Property
...
```
```
public PropertyValue DMPLAOBJECT_SEGMENT_DIGITAL_PLCOUTPUT_COUNT( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.PlanningSegmentPropertyList~DMPLAOBJECT_SEGMENT_DIGITAL_PLCOUTPUT_COUNT(Int32))