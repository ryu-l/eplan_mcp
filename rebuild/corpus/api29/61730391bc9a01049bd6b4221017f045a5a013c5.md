# MDPartSupportBarPosition Class Members

MDPartSupportBarPosition Class Members

The following tables list the members exposed by [MDPartSupportBarPosition](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartSupportBarPosition.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartSupportBarPosition)