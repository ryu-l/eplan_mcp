# MountingPointMate Class Members

MountingPointMate Class Members

The following tables list the members exposed by [MountingPointMate](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.MountingPointMate.html).
...
| Public Method | [Create](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.MountingPointMate~Create(String,MultiLangString,Matrix3D).html) | Creates a mounting point mate. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.MountingPointMate)