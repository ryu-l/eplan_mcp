# TerminalsToConnectionPointsMappingException Class Members

TerminalsToConnectionPointsMappingException Class Members

The following tables list the members exposed by [TerminalsToConnectionPointsMappingException](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.TerminalsToConnectionPointsMappingException.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.TerminalsToConnectionPointsMappingException)