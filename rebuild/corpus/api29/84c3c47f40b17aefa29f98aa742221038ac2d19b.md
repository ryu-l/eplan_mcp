# DMG_VIEWPLACEMENT_MAINOBJECT(Int32) Property

DMG\_VIEWPLACEMENT\_MAINOBJECT(Int32) Property
...
```
```
public PropertyValue DMG_VIEWPLACEMENT_MAINOBJECT( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.ViewPlacementPropertyList~DMG_VIEWPLACEMENT_MAINOBJECT(Int32))