# ARTICLE_SUPPLIER Property (ArticlePropertyList)

ARTICLE\_SUPPLIER Property (ArticlePropertyList)
...
| --- | --- |
| [ARTICLE\_SUPPLIER(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_SUPPLIER(Int32).html) | Supplier # 22008. This property isn't indexed. |
| [ARTICLE\_SUPPLIER](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_SUPPLIER().html) | Supplier # 22008. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_SUPPLIER)