# FUNC_DT_COLUMN(Int32) Property

FUNC\_DT\_COLUMN(Int32) Property
...
```
```
public PropertyValue FUNC_DT_COLUMN( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~FUNC_DT_COLUMN(Int32))