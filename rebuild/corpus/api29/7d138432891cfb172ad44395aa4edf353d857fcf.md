...
```
```
public class Function : FunctionBase, IArticleUser, IFunctionBase, IWriteProtection
```
```

```
```
public ref class Function : public FunctionBase, IArticleUser, IFunctionBase, IWriteProtection
```
```
...
- [C#](#i-tab-content-2c8289df-0b59-4961-be77-79c2cddb840b)
...
oNewFunction.Create(m_oTestProject.Pages[9], oSymbolVariant);
...
- [C#](#i-tab-content-faa83c23-a850-49db-a3c9-fe429b67c80e)
...
| Public Property | [Category](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Function~Category.html) | Returns the [Category](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Function~Category.html) of the Function. |
...
| Public Property | [ManualPlacementType](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Function~ManualPlacementType.html) | Gets custom placement type. Placement type express how function will be shown on schema. |
...
| Public Method | [Assign](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Function~Assign(Function).html) | Assigns this function to another, which means that values of this function's properties are copied to the target object and the function itself is removed from the project. |
...
| Public Method | [IsPointInsideLogicalArea](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Function~IsPointInsideLogicalArea(PointD).html) | Overridden. Tells if the point is inside Functions logical area. |
...
| Public Method | [PauseWriteProtection](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Function~PauseWriteProtection.html) | Temporarily disables write protection. Note that current write protection |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Function)