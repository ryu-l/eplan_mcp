# DMG_VIEWPLACEMENT_FREE_ROUTED_CONNECTIONS(Int32) Property

DMG\_VIEWPLACEMENT\_FREE\_ROUTED\_CONNECTIONS(Int32) Property
...
```
```
public PropertyValue DMG_VIEWPLACEMENT_FREE_ROUTED_CONNECTIONS( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.ViewPlacementPropertyList~DMG_VIEWPLACEMENT_FREE_ROUTED_CONNECTIONS(Int32))