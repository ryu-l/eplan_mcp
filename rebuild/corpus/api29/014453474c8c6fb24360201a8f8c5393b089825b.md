...
| --- | --- |
| [INTRINSICSAFETY(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~INTRINSICSAFETY(Int32).html) | Intrinsically safe # 31030. This property isn't indexed. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~INTRINSICSAFETY)