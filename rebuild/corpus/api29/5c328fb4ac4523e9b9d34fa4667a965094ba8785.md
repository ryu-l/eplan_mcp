# SymbolLibrary Class Members

SymbolLibrary Class Members

The following tables list the members exposed by [SymbolLibrary](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolLibrary.html).
...
| Public Property | [Project](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolLibrary~Project.html) | Overridden. Returns the project the StorableObject belongs to. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolLibrary)