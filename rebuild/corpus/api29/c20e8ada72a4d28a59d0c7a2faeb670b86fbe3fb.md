# Exists Method (FunctionDefinitionLibraryPropertyList)
...
| --- | --- |
| [Exists(FunctionDefinitionLibrary)](topic1743.html) | Checks property existence for used obiect. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.FunctionDefinitionLibraryPropertyList~Exists)