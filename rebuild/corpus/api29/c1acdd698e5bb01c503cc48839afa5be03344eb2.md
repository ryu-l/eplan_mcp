# GridLineMate Class Members

GridLineMate Class Members

The following tables list the members exposed by [GridLineMate](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.GridLineMate.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.GridLineMate)