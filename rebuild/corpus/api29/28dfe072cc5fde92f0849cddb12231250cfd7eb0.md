# ARTICLE_LIFETIME Property (ArticlePropertyList)

ARTICLE\_LIFETIME Property (ArticlePropertyList)
...
| --- | --- |
| [ARTICLE\_LIFETIME(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_LIFETIME(Int32).html) | Service time # 22142. This property isn't indexed. |
| [ARTICLE\_LIFETIME](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_LIFETIME().html) | Service time # 22142. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_LIFETIME)