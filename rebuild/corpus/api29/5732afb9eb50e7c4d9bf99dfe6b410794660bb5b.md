...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.HEServicesu~Eplan.EplApi.HEServices.Revision~CompareProjects(Project,Project,String,Boolean,String,Boolean,Boolean,Boolean))