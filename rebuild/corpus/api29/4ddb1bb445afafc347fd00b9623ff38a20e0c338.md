...
```
```
public class StrandInterConnector : SymbolReference
```
```

```
```
public ref class StrandInterConnector : public SymbolReference
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StrandInterConnector)