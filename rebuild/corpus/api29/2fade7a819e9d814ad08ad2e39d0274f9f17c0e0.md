# FUNC_ARTICLE_TERMINALSORTCODE Property (FunctionPropertyList)

FUNC\_ARTICLE\_TERMINALSORTCODE Property (FunctionPropertyList)
...
| --- | --- |
| [FUNC\_ARTICLE\_TERMINALSORTCODE(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionPropertyList~FUNC_ARTICLE_TERMINALSORTCODE(Int32).html) | Sorting of part on terminal strip # 20104. |
| [FUNC\_ARTICLE\_TERMINALSORTCODE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionPropertyList~FUNC_ARTICLE_TERMINALSORTCODE().html) | Sorting of part on terminal strip # 20104. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionPropertyList~FUNC_ARTICLE_TERMINALSORTCODE)