...
```
```
public class Plane : Placement3D, Eplan.EplApi.DataModel.IFunctionBase
```
```

```
```
public ref class Plane : public Placement3D, Eplan.EplApi.DataModel.IFunctionBase
```
```
...
| Public Property | [AdditionalType](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Plane~AdditionalType.html) | Additional Type of Plane. |
...
| Public Property | [PlaneMode](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Plane~PlaneMode.html) | Returns mode of plane. |
...
| Public Method | [GetValidAdditionalTypes](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Plane~GetValidAdditionalTypes.html) | Returns array of Additional Types that are valid for Plane. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Plane)