# EmptyPropertyException Class Members

EmptyPropertyException Class Members

The following tables list the members exposed by [EmptyPropertyException](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.EmptyPropertyException.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.EmptyPropertyException)