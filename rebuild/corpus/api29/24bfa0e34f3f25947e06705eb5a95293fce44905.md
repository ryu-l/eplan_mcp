...
- [C#](#i-tab-content-7dff8b50-f473-46f2-9fdf-8e6065a94415)
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.MountingPanel~CreateTransient(Project,String,String,Int32,List{Placement3D}))