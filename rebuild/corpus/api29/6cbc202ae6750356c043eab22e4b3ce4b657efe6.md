# CreatingConnectionDefinitionPointsFailedException Class Members

CreatingConnectionDefinitionPointsFailedException Class Members

The following tables list the members exposed by [CreatingConnectionDefinitionPointsFailedException](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.CreatingConnectionDefinitionPointsFailedException.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.CreatingConnectionDefinitionPointsFailedException)