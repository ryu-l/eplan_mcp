# DimensionSuffix Property (DimensionItem)

DimensionSuffix Property (DimensionItem)

Gets the suffix of DimensionItem.
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.DimensionItem~DimensionSuffix)