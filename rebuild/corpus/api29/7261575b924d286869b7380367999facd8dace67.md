# FUNC_ARTICLE_ADDITIONAL_TEXTFIELD Property (ConnectionPropertyList)

FUNC\_ARTICLE\_ADDITIONAL\_TEXTFIELD Property (ConnectionPropertyList)
...
| --- | --- |
| [FUNC\_ARTICLE\_ADDITIONAL\_TEXTFIELD(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~FUNC_ARTICLE_ADDITIONAL_TEXTFIELD(Int32).html) | Suppl. field: Text # 20915. |
| [FUNC\_ARTICLE\_ADDITIONAL\_TEXTFIELD](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~FUNC_ARTICLE_ADDITIONAL_TEXTFIELD().html) | Suppl. field: Text # 20915. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~FUNC_ARTICLE_ADDITIONAL_TEXTFIELD)