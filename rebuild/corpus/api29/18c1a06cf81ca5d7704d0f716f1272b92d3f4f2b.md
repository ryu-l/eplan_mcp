# NotIndexedPropertyException Class Members

NotIndexedPropertyException Class Members

The following tables list the members exposed by [NotIndexedPropertyException](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.NotIndexedPropertyException.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.NotIndexedPropertyException)