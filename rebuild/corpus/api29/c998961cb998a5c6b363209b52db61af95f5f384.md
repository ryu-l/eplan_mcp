...
The following tables list the members exposed by [MergedConnectionPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedConnectionPropertyList.html).
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedConnectionPropertyList)