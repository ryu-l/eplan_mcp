# LINE_END_Y(Int32) Property

LINE\_END\_Y(Int32) Property
...
```
```
public PropertyValue LINE_END_Y( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.LinePropertyList~LINE_END_Y(Int32))