...
| --- | --- |
| [PROJ\_BLOCKFORMAT\_FUNCTION(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectPropertyList~PROJ_BLOCKFORMAT_FUNCTION(Int32).html) | Block property: Format (general devices) # 10600. |
| [PROJ\_BLOCKFORMAT\_FUNCTION](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectPropertyList~PROJ_BLOCKFORMAT_FUNCTION().html) | Block property: Format (general devices) # 10600. |
