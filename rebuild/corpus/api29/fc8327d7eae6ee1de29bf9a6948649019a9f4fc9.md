...
In [UsingEplanAssemblies](UsingEplanAssemblies.html), please make sure to clean up. The DrawingService object before calling **Eplan::EplApi::System::EplApplication:**. The finalizer of DrawingService needs the API to be initialized for freeing the internal display list.
...
- [C#](#i-tab-content-480fbcbc-b792-4e3e-91f5-9132ccc1db64)
...
- [C#](#i-tab-content-e39f4551-e325-42df-b098-bba25ca121a5)
...
| Public Method | [setDrawingFlags](Eplan.EplApi.HEServicesu~Eplan.EplApi.HEServices.DrawingService~setDrawingFlags.html) | For internal use. |
...
| Public Method | [testDrawingFlags](Eplan.EplApi.HEServicesu~Eplan.EplApi.HEServices.DrawingService~testDrawingFlags.html) | For internal use. |
| Public Method | [unsetDrawingFlags](Eplan.EplApi.HEServicesu~Eplan.EplApi.HEServices.DrawingService~unsetDrawingFlags.html) | For internal use. |
...
| Public Method | [ZoomIn](Eplan.EplApi.HEServicesu~Eplan.EplApi.HEServices.DrawingService~ZoomIn(Double).html) | Recalculates the view port to zoom into the image. |
| Public Method | [ZoomOut](Eplan.EplApi.HEServicesu~Eplan.EplApi.HEServices.DrawingService~ZoomOut(Double).html) | Recalculates the view port to zoom out of the image. |
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.HEServicesu~Eplan.EplApi.HEServices.DrawingService)