# DMPLAOBJECT_ANALOG_PLCOUTPUT_COUNT(Int32) Property

DMPLAOBJECT\_ANALOG\_PLCOUTPUT\_COUNT(Int32) Property
...
```
```
public PropertyValue DMPLAOBJECT_ANALOG_PLCOUTPUT_COUNT( 
   int index
) {get; set;}
```
```
...
[Send Feedback](mailto:Support-API@eplan.de?subject=Documentation Feedback: Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.PlanningSegmentPropertyList~DMPLAOBJECT_ANALOG_PLCOUTPUT_COUNT(Int32))