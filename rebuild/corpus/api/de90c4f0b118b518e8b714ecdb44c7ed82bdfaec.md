# ProjectCreationException Class Members

ProjectCreationException Class Members

The following tables list the members exposed by [ProjectCreationException](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectCreationException.html).
