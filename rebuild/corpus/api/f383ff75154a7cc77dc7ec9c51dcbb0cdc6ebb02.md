# FUNC_CIRCUITNUMBER Property (ArticleReferencePropertyList)

FUNC\_CIRCUITNUMBER Property (ArticleReferencePropertyList)
...
| --- | --- |
| [FUNC\_CIRCUITNUMBER](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~FUNC_CIRCUITNUMBER().html) | Circuit number # 20317. |
