# ARTICLE_MATERIAL_LIST Property (ConnectionDefinitionPointPropertyList)

ARTICLE\_MATERIAL\_LIST Property (ConnectionDefinitionPointPropertyList)
...
| --- | --- |
| [ARTICLE\_MATERIAL\_LIST](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionDefinitionPointPropertyList~ARTICLE_MATERIAL_LIST().html) | Material selection list # 26656. |
