# ARTICLE_ACTIVE_POWER_MAX_ASV Property (ArticlePropertyList)

ARTICLE\_ACTIVE\_POWER\_MAX\_ASV Property (ArticlePropertyList)
...
| --- | --- |
| [ARTICLE\_ACTIVE\_POWER\_MAX\_ASV](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_ACTIVE_POWER_MAX_ASV().html) | Active power (general power supply), max. # 26643. |
