...
| --- | --- |
| [CONNECTION\_TERMINALSIZE\_SOURCE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionDefinitionPointPropertyList~CONNECTION_TERMINALSIZE_SOURCE().html) | Connection dimension source # 31096. |
