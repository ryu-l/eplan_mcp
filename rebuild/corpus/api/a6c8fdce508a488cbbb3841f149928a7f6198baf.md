...
| --- | --- |
| [SYMB\_DEFAULT\_ALTERNATIVE\_PROPERTYSET\_B](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolPropertyList~SYMB_DEFAULT_ALTERNATIVE_PROPERTYSET_B().html) | Default property arrangement for variant B (alternative) # 16034. |
