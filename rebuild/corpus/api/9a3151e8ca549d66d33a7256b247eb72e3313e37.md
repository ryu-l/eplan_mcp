# ARTICLE_ACTIVE_POWER_MAX_NEA Property (MDPartsDatabaseItemPropertyList)

ARTICLE\_ACTIVE\_POWER\_MAX\_NEA Property (MDPartsDatabaseItemPropertyList)
...
| --- | --- |
| [ARTICLE\_ACTIVE\_POWER\_MAX\_NEA](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_ACTIVE_POWER_MAX_NEA().html) | Active power (emergency power system), max. # 26645. |
