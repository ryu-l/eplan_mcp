# ARTICLE_ACTIVE_POWER_MAX_UPS Property (ArticleReferencePropertyList)

ARTICLE\_ACTIVE\_POWER\_MAX\_UPS Property (ArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_ACTIVE\_POWER\_MAX\_UPS](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~ARTICLE_ACTIVE_POWER_MAX_UPS().html) | Active power (uninterruptible power supply), max. # 26647. |
