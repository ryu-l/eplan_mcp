# ARTICLE_RATED_CURRENT_MIN Property (ArticleReferencePropertyList)

ARTICLE\_RATED\_CURRENT\_MIN Property (ArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_RATED\_CURRENT\_MIN](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~ARTICLE_RATED_CURRENT_MIN().html) | Nominal current, min. # 26502. |
