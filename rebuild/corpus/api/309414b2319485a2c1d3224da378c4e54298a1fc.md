# FUNC_ARTICLE_ACTUAL_OUTPUT_HYDRAULIC Property (ConnectionPropertyList)

FUNC\_ARTICLE\_ACTUAL\_OUTPUT\_HYDRAULIC Property (ConnectionPropertyList)
...
| --- | --- |
| [FUNC\_ARTICLE\_ACTUAL\_OUTPUT\_HYDRAULIC(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~FUNC_ARTICLE_ACTUAL_OUTPUT_HYDRAULIC(Int32).html) | Actual power (hydraulic) # 26382. |
