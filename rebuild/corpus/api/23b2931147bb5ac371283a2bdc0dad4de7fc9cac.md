# ARTICLE_CONNECTION_TYPE Property (MergedArticleReferencePropertyList)

ARTICLE\_CONNECTION\_TYPE Property (MergedArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_CONNECTION\_TYPE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLE_CONNECTION_TYPE().html) | Connection point type # 26204. |
