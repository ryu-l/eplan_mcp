# ARTICLE_GROUPSYMBOLMACRO_NFPA_MM Property (ArticleReferencePropertyList)

ARTICLE\_GROUPSYMBOLMACRO\_NFPA\_MM Property (ArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_GROUPSYMBOLMACRO\_NFPA\_MM](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~ARTICLE_GROUPSYMBOLMACRO_NFPA_MM().html) | Schematic macro: NFPA mm # 22871. |
