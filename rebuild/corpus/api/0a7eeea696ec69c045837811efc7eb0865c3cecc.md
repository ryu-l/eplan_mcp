...
This class represents a collection of properties of [OptionBase](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.OptionBase.html) class. Please also check the base classes for other properties that are available for [OptionBase](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.OptionBase.html) objects: [StorableObjectPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObjectPropertyList.html)
...
- [C#](#i-tab-content-28f48689-ec92-4cf2-a07b-031eb1dd6a5d)
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [OptionBasePropertyList Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.OptionBasePropertyList~_ctor().html) | Constructor |
