# ARTICLE_MAINTENANCE_CYCLE Property (MergedArticleReferencePropertyList)

ARTICLE\_MAINTENANCE\_CYCLE Property (MergedArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_MAINTENANCE\_CYCLE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLE_MAINTENANCE_CYCLE().html) | Maintenance cycle # 26637. |
