# DocumentBase Class Members

DocumentBase Class Members

The following tables list the members exposed by [DocumentBase](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.DocumentBase.html).
