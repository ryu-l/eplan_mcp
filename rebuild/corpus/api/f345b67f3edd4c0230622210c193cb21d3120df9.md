...
Returns [Eplan.EplApi.DataModel.PotentialDefinition](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PotentialDefinition.html)s matching the given filter from the potential navigator.
...
*strFilterScheme*
:   Scheme name of filter from the potential navigator
