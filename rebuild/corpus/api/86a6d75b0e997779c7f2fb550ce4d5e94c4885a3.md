# ARTICLE_MATERIAL_LIST Property (MDPartsDatabaseItemPropertyList)

ARTICLE\_MATERIAL\_LIST Property (MDPartsDatabaseItemPropertyList)
...
| --- | --- |
| [ARTICLE\_MATERIAL\_LIST](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_MATERIAL_LIST().html) | Material selection list # 26656. |
