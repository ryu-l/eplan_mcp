# FUNC_ARTICLE_POSITION_NUMBER_STLB Property (ProjectPropertyList)

FUNC\_ARTICLE\_POSITION\_NUMBER\_STLB Property (ProjectPropertyList)
...
| --- | --- |
| [FUNC\_ARTICLE\_POSITION\_NUMBER\_STLB(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectPropertyList~FUNC_ARTICLE_POSITION_NUMBER_STLB(Int32).html) | Performance description, standardized: Item number (device, utility, service) # 26533. |
