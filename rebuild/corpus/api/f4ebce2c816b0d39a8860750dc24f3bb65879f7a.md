...
| --- | --- |
| [FUNCTION3D\_IDCOUNTER\_RELATIVE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Placement3DPropertyList~FUNCTION3D_IDCOUNTER_RELATIVE().html) | Counter in item ID (relative to macro, EEC) # 36034. |
