# NOPLCCPU Class Members

NOPLCCPU Class Members

The following tables list the members exposed by [NOPLCCPU](Eplan.EplApi.HEServicesu~Eplan.EplApi.HEServices.Exceptions.NOPLCCPU.html).
