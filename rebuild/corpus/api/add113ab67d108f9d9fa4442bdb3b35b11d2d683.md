# ARTICLE_MEASURING_ACCURACY Property (MDPartsDatabaseItemPropertyList)

ARTICLE\_MEASURING\_ACCURACY Property (MDPartsDatabaseItemPropertyList)
...
| --- | --- |
| [ARTICLE\_MEASURING\_ACCURACY](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_MEASURING_ACCURACY().html) | Measurement accuracy # 26458. |
