# ARTICLE_POWER_DESCRIPTION Property (ArticlePropertyList)

ARTICLE\_POWER\_DESCRIPTION Property (ArticlePropertyList)
...
| --- | --- |
| [ARTICLE\_POWER\_DESCRIPTION](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_POWER_DESCRIPTION().html) | Performance description (item, device) # 26427. |
