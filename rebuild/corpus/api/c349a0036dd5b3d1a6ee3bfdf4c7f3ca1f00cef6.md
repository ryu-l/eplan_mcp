# WrongCategoryException Class Members

WrongCategoryException Class Members

The following tables list the members exposed by [WrongCategoryException](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.WrongCategoryException.html).
