# ARTICLE_RATED_DRIVING_TORQUE Property (MDPartsDatabaseItemPropertyList)

ARTICLE\_RATED\_DRIVING\_TORQUE Property (MDPartsDatabaseItemPropertyList)
...
| --- | --- |
| [ARTICLE\_RATED\_DRIVING\_TORQUE](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_RATED_DRIVING_TORQUE().html) | Nominal drive torque # 26466. |
