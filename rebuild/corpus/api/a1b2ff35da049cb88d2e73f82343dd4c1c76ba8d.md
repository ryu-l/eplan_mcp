...
| --- | --- |
| [SYMB\_DEFAULT\_ALTERNATIVE\_PROPERTYSET\_A](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolPropertyList~SYMB_DEFAULT_ALTERNATIVE_PROPERTYSET_A().html) | Default property arrangement for variant A (alternative) # 16033. |
