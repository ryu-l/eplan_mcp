# DESIGNATION_USERDEFINED_SUB7 Property (PlanningSegmentPropertyList)

DESIGNATION\_USERDEFINED\_SUB7 Property (PlanningSegmentPropertyList)
...
| --- | --- |
| [DESIGNATION\_USERDEFINED\_SUB7](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.PlanningSegmentPropertyList~DESIGNATION_USERDEFINED_SUB7().html) | User-defined structure (sub-identifier 7) # 1607. |
