# ARTICLE_CONTAINS_ASSEMBLIES Property (ArticlePropertyList)

ARTICLE\_CONTAINS\_ASSEMBLIES Property (ArticlePropertyList)
...
| --- | --- |
| [ARTICLE\_CONTAINS\_ASSEMBLIES](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_CONTAINS_ASSEMBLIES().html) | Contains assemblies # 22425. |
