# ARTICLE_NOMINAL_VOLUME_FLOW Property (MDPartsDatabaseItemPropertyList)

ARTICLE\_NOMINAL\_VOLUME\_FLOW Property (MDPartsDatabaseItemPropertyList)
...
| --- | --- |
| [ARTICLE\_NOMINAL\_VOLUME\_FLOW](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_NOMINAL_VOLUME_FLOW().html) | Nominal flow rate # 26506. |
