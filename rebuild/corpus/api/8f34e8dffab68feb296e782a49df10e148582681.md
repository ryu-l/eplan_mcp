# ARTICLE_ULTIMATE_BREAKING_CAPACITY Property (MDPartsDatabaseItemPropertyList)

ARTICLE\_ULTIMATE\_BREAKING\_CAPACITY Property (MDPartsDatabaseItemPropertyList)
...
| --- | --- |
| [ARTICLE\_ULTIMATE\_BREAKING\_CAPACITY](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_ULTIMATE_BREAKING_CAPACITY().html) | Rated ultimate short-circuit breaking capacity (Icu) # 26587. |
