# ARTICLE_TEMPERATURE_MAX Property (MergedArticleReferencePropertyList)

ARTICLE\_TEMPERATURE\_MAX Property (MergedArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_TEMPERATURE\_MAX](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLE_TEMPERATURE_MAX().html) | Temperature, max. # 26607. |
