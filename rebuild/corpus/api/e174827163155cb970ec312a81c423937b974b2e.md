# FUNC_ARTICLE_ACTUAL_OUTPUT_PNEUMATIC Property (ConnectionPropertyList)

FUNC\_ARTICLE\_ACTUAL\_OUTPUT\_PNEUMATIC Property (ConnectionPropertyList)
...
| --- | --- |
| [FUNC\_ARTICLE\_ACTUAL\_OUTPUT\_PNEUMATIC(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~FUNC_ARTICLE_ACTUAL_OUTPUT_PNEUMATIC(Int32).html) | Actual power (pneumatic) # 26388. |
