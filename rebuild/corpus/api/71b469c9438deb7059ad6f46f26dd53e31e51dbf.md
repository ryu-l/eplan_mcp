# FUNC_ARTICLE_TEMPERATURE_RANGE_MEDIUM_MAX Property (ProjectPropertyList)

FUNC\_ARTICLE\_TEMPERATURE\_RANGE\_MEDIUM\_MAX Property (ProjectPropertyList)
...
| --- | --- |
| [FUNC\_ARTICLE\_TEMPERATURE\_RANGE\_MEDIUM\_MAX(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectPropertyList~FUNC_ARTICLE_TEMPERATURE_RANGE_MEDIUM_MAX(Int32).html) | Temperature range (medium), max. # 26616. |
