# ARTICLE_ERPNR_8 Property (MergedArticleReferencePropertyList)

ARTICLE\_ERPNR\_8 Property (MergedArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_ERPNR\_8](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLE_ERPNR_8().html) | ERP / PDM number 8 # 22377. |
