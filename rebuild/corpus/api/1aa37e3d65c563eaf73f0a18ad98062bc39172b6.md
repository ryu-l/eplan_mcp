# FUNC_ARTICLE_SERVICE_UNIT Property (PlanningSegmentPropertyList)

FUNC\_ARTICLE\_SERVICE\_UNIT Property (PlanningSegmentPropertyList)
...
| --- | --- |
| [FUNC\_ARTICLE\_SERVICE\_UNIT](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.PlanningSegmentPropertyList~FUNC_ARTICLE_SERVICE_UNIT(Int32).html) | Performance unit (bill of quantities) # 26430. |
