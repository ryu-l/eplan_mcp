...
This constructor initializes the symbol library using the "[Initialize](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolLibrary~Initialize.html)" method.
