# ARTICLE_NOMINAL_WIDTH_CONNECTION_SIZE Property (ArticlePropertyList)

ARTICLE\_NOMINAL\_WIDTH\_CONNECTION\_SIZE Property (ArticlePropertyList)
...
| --- | --- |
| [ARTICLE\_NOMINAL\_WIDTH\_CONNECTION\_SIZE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_NOMINAL_WIDTH_CONNECTION_SIZE().html) | Nominal size / connection size # 26514. |
