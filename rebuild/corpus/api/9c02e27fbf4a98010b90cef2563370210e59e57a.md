...
This class represents a collection of properties of [Line](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Line.html) class. Please also check the base classes for other properties that are available for [Line](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.Line.html) objects: [GraphicalPlacementPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.GraphicalPlacementPropertyList.html), [Eplan.EplApi.DataModel.PlacementPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PlacementPropertyList.html), [Eplan.EplApi.DataModel.StorableObjectPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObjectPropertyList.html)
...
- [C#](#i-tab-content-d9447f7e-c656-4674-8f01-2437dc0445ba)
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [LinePropertyList Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.LinePropertyList~_ctor().html) | Constructor |
