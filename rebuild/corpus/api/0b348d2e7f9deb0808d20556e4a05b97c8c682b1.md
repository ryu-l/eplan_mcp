# MACROFILE_CHANGEDATE Property (MacroEntryPropertyList)

MACROFILE\_CHANGEDATE Property (MacroEntryPropertyList)
...
| --- | --- |
| [MACROFILE\_CHANGEDATE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MacroEntryPropertyList~MACROFILE_CHANGEDATE().html) | Macro: Modification date # 23019. |
