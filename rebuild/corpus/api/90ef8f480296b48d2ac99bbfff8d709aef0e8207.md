...
This class represents a collection of properties of [Location](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Location.html) class. Please also check the base classes for other properties that are available for [Location](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Location.html) objects: [StorableObjectPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObjectPropertyList.html)
...
- [C#](#i-tab-content-14461d6a-55ea-4398-b906-6c60c2ce08b2)
...
|  | Name | Description |
| --- | --- | --- |
| Public Constructor | [LocationPropertyList Constructor](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.LocationPropertyList~_ctor().html) | Constructor |
