# IPlaceHolder Interface Members

IPlaceHolder Interface Members

The following tables list the members exposed by [IPlaceHolder](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.IPlaceHolder.html).
