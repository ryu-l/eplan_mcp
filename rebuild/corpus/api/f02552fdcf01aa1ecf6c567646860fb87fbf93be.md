# DMPLAOBJECT_PLCADDRESS_SYMBOLICADDRESS_UDT Property (SegmentTemplatePropertyList)

DMPLAOBJECT\_PLCADDRESS\_SYMBOLICADDRESS\_UDT Property (SegmentTemplatePropertyList)
...
| --- | --- |
| [DMPLAOBJECT\_PLCADDRESS\_SYMBOLICADDRESS\_UDT](topic1087.html) | PLC address: Symbolic address: UDT (name) # 44088. |
