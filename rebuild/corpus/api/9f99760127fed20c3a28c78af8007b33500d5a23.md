# ARTICLE_NOMINAL_WIDTH Property (MergedArticleReferencePropertyList)

ARTICLE\_NOMINAL\_WIDTH Property (MergedArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_NOMINAL\_WIDTH](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLE_NOMINAL_WIDTH().html) | Nominal size / diameter # 26512. |
