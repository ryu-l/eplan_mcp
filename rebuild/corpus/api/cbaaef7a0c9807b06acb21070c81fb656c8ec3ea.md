# ARTICLE_SOUND_INSULATION Property (MDPartsDatabaseItemPropertyList)

ARTICLE\_SOUND\_INSULATION Property (MDPartsDatabaseItemPropertyList)
...
| --- | --- |
| [ARTICLE\_SOUND\_INSULATION](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_SOUND_INSULATION().html) | Sound insulation # 26543. |
