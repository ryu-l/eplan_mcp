# ARTICLE_GROUPSYMBOLMACRO_NFPA_MM Property (MDPartsDatabaseItemPropertyList)

ARTICLE\_GROUPSYMBOLMACRO\_NFPA\_MM Property (MDPartsDatabaseItemPropertyList)
...
| --- | --- |
| [ARTICLE\_GROUPSYMBOLMACRO\_NFPA\_MM](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_GROUPSYMBOLMACRO_NFPA_MM().html) | Schematic macro: NFPA mm # 22871. |
