# ARTICLE_GROUPSYMBOLMACRO_NFPA_MM Property (ArticlePropertyList)

ARTICLE\_GROUPSYMBOLMACRO\_NFPA\_MM Property (ArticlePropertyList)
...
| --- | --- |
| [ARTICLE\_GROUPSYMBOLMACRO\_NFPA\_MM](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_GROUPSYMBOLMACRO_NFPA_MM().html) | Schematic macro: NFPA mm # 22871. |
