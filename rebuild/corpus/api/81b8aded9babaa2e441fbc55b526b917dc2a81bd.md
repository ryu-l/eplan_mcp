# ARTICLE_ADDRESSRANGE_2 Property (MDPartsDatabaseItemPropertyList)

ARTICLE\_ADDRESSRANGE\_2 Property (MDPartsDatabaseItemPropertyList)
...
| --- | --- |
| [ARTICLE\_ADDRESSRANGE\_2](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_ADDRESSRANGE_2().html) | Address range 2 (SIEMENS STEP 7 Classic) # 22261. |
