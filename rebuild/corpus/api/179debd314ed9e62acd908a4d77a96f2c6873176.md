# ARTICLE_NOMINAL_VOLUME_FLOW Property (ArticleReferencePropertyList)

ARTICLE\_NOMINAL\_VOLUME\_FLOW Property (ArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_NOMINAL\_VOLUME\_FLOW](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~ARTICLE_NOMINAL_VOLUME_FLOW().html) | Nominal flow rate # 26506. |
