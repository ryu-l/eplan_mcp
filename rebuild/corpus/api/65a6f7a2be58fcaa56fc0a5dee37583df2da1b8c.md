# FUNC_PLCGROUP_STARTADDRESS_2_OUTPUTS Property (FunctionPropertyList)

FUNC\_PLCGROUP\_STARTADDRESS\_2\_OUTPUTS Property (FunctionPropertyList)
...
| --- | --- |
| [FUNC\_PLCGROUP\_STARTADDRESS\_2\_OUTPUTS](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionPropertyList~FUNC_PLCGROUP_STARTADDRESS_2_OUTPUTS().html) | PLC subdevice 2: Start address (outputs) # 20455. |
