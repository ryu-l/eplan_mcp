# ARTICLE_INTAKE_VOLUME_FLOW_MIN Property (MDPartsDatabaseItemPropertyList)

ARTICLE\_INTAKE\_VOLUME\_FLOW\_MIN Property (MDPartsDatabaseItemPropertyList)
...
| --- | --- |
| [ARTICLE\_INTAKE\_VOLUME\_FLOW\_MIN](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_INTAKE_VOLUME_FLOW_MIN().html) | Intake flow rate, min. # 26200. |
