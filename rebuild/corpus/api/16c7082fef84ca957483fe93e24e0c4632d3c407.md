...
| --- | --- |
| [MESSAGEMGMT\_MESSAGES](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.InterruptionPointPropertyList~MESSAGEMGMT_MESSAGES().html) | Check run messages available # 20930. |
