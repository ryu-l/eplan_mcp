# ARTICLE_SURFACE Property (MDPartsDatabaseItemPropertyList)

ARTICLE\_SURFACE Property (MDPartsDatabaseItemPropertyList)
...
| --- | --- |
| [ARTICLE\_SURFACE](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_SURFACE().html) | Type of surface # 26225. |
