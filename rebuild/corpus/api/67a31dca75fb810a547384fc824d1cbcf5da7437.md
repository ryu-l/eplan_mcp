# ARTICLE_WEIGHT_OF_THE_PACKAGING Property (MergedArticleReferencePropertyList)

ARTICLE\_WEIGHT\_OF\_THE\_PACKAGING Property (MergedArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_WEIGHT\_OF\_THE\_PACKAGING](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLE_WEIGHT_OF_THE_PACKAGING().html) | Weight (packaging) # 26378. |
