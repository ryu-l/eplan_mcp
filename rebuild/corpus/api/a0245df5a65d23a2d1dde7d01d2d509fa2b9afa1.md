# FUNC_ARTICLE_ACTIVE_POWER_MAX_UPS Property (ProjectPropertyList)

FUNC\_ARTICLE\_ACTIVE\_POWER\_MAX\_UPS Property (ProjectPropertyList)
...
| --- | --- |
| [FUNC\_ARTICLE\_ACTIVE\_POWER\_MAX\_UPS(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectPropertyList~FUNC_ARTICLE_ACTIVE_POWER_MAX_UPS(Int32).html) | Active power (uninterruptible power supply), max. # 26648. |
