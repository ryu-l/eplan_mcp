# ARTICLE_OPERATING_VOLTAGE_WITH_DC_MAX Property (ArticlePropertyList)

ARTICLE\_OPERATING\_VOLTAGE\_WITH\_DC\_MAX Property (ArticlePropertyList)
...
| --- | --- |
| [ARTICLE\_OPERATING\_VOLTAGE\_WITH\_DC\_MAX](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_OPERATING_VOLTAGE_WITH_DC_MAX().html) | Operating voltage (DC), max. # 26091. |
