# ARTICLE_GROUPSYMBOLMACRO_GB_CCC Property (ArticleReferencePropertyList)

ARTICLE\_GROUPSYMBOLMACRO\_GB\_CCC Property (ArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_GROUPSYMBOLMACRO\_GB\_CCC](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~ARTICLE_GROUPSYMBOLMACRO_GB_CCC().html) | Schematic macro: GB/CCC # 22873. |
