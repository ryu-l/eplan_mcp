# FUNC_DT_SECTION Property (MergedArticleReferencePropertyList)

FUNC\_DT\_SECTION Property (MergedArticleReferencePropertyList)
...
| --- | --- |
| [FUNC\_DT\_SECTION](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~FUNC_DT_SECTION().html) | DT: Section # 20154. |
