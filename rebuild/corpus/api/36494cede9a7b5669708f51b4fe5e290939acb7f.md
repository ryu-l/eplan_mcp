# ARTICLE_FREQUENCY_RANGE_MIN Property (MergedArticleReferencePropertyList)

ARTICLE\_FREQUENCY\_RANGE\_MIN Property (MergedArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_FREQUENCY\_RANGE\_MIN](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLE_FREQUENCY_RANGE_MIN().html) | Frequency range, min. # 26332. |
