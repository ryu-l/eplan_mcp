# ARTICLE_GROUPSYMBOLMACRO_GB_CCC Property (MergedArticleReferencePropertyList)

ARTICLE\_GROUPSYMBOLMACRO\_GB\_CCC Property (MergedArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_GROUPSYMBOLMACRO\_GB\_CCC](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLE_GROUPSYMBOLMACRO_GB_CCC().html) | Schematic macro: GB/CCC # 22873. |
