# ARTICLE_THREAD_SIZE_FITTING Property (MDPartsDatabaseItemPropertyList)

ARTICLE\_THREAD\_SIZE\_FITTING Property (MDPartsDatabaseItemPropertyList)
...
| --- | --- |
| [ARTICLE\_THREAD\_SIZE\_FITTING](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_THREAD_SIZE_FITTING().html) | Thread dimension (fitting) # 26109. |
