# FUNC_ARTICLE_ACTUAL_OUTPUT_HYDRAULIC_MAX Property (ConnectionPropertyList)

FUNC\_ARTICLE\_ACTUAL\_OUTPUT\_HYDRAULIC\_MAX Property (ConnectionPropertyList)
...
| --- | --- |
| [FUNC\_ARTICLE\_ACTUAL\_OUTPUT\_HYDRAULIC\_MAX(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~FUNC_ARTICLE_ACTUAL_OUTPUT_HYDRAULIC_MAX(Int32).html) | Actual power (hydraulic), max. # 26384. |
