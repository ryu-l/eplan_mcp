# ARTICLE_BACNET Property (MergedArticleReferencePropertyList)

ARTICLE\_BACNET Property (MergedArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_BACNET](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLE_BACNET().html) | BACnet # 26227. |
