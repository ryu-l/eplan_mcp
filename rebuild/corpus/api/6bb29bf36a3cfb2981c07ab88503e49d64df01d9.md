# ARTICLE_TIGHTENING_TORQUE_MAX Property (MDPartsDatabaseItemPropertyList)

ARTICLE\_TIGHTENING\_TORQUE\_MAX Property (MDPartsDatabaseItemPropertyList)
...
| --- | --- |
| [ARTICLE\_TIGHTENING\_TORQUE\_MAX](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_TIGHTENING_TORQUE_MAX().html) | Tightening torque, max. # 26081. |
