# ARTICLE_MATERIAL_LIST Property (PipingDefinitionPropertyList)

ARTICLE\_MATERIAL\_LIST Property (PipingDefinitionPropertyList)
...
| --- | --- |
| [ARTICLE\_MATERIAL\_LIST](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PipingDefinitionPropertyList~ARTICLE_MATERIAL_LIST().html) | Material selection list # 26656. |
