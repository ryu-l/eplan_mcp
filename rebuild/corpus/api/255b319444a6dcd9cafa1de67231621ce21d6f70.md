# ARTICLE_MEASURING_RANGE_OF_HUMIDITY_PERCENTRH Property (ArticlePropertyList)

ARTICLE\_MEASURING\_RANGE\_OF\_HUMIDITY\_PERCENTRH Property (ArticlePropertyList)
...
| --- | --- |
| [ARTICLE\_MEASURING\_RANGE\_OF\_HUMIDITY\_PERCENTRH](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_MEASURING_RANGE_OF_HUMIDITY_PERCENTRH().html) | Measuring range: Humidity (in %r.H.) # 26447. |
