# ARTICLE_TEMPERATURE_RANGE_MEDIUM_MIN Property (ArticlePropertyList)

ARTICLE\_TEMPERATURE\_RANGE\_MEDIUM\_MIN Property (ArticlePropertyList)
...
| --- | --- |
| [ARTICLE\_TEMPERATURE\_RANGE\_MEDIUM\_MIN](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_TEMPERATURE_RANGE_MEDIUM_MIN().html) | Temperature range (medium), min. # 26617. |
