# ARTICLE_DISASSEMBLE3_MODE Property (ArticlePropertyList)

ARTICLE\_DISASSEMBLE3\_MODE Property (ArticlePropertyList)
...
| --- | --- |
| [ARTICLE\_DISASSEMBLE3\_MODE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_DISASSEMBLE3_MODE().html) | Break up in summarized parts list (manufacturing data) # 22417. |
