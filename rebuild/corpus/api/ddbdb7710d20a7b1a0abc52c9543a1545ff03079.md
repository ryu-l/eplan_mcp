# ARTICLE_SUCTION_VOLUME_FLOW_MAX Property (ArticleReferencePropertyList)

ARTICLE\_SUCTION\_VOLUME\_FLOW\_MAX Property (ArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_SUCTION\_VOLUME\_FLOW\_MAX](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~ARTICLE_SUCTION_VOLUME_FLOW_MAX().html) | Intake flow rate, max. # 26198. |
