# QRCodePropertyList Class Members

QRCodePropertyList Class Members

The following tables list the members exposed by [QRCodePropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Graphics.QRCodePropertyList.html).
