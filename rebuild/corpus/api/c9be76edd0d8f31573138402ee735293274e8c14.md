# ARTICLE_SERVICE_UNIT Property (MergedArticleReferencePropertyList)

ARTICLE\_SERVICE\_UNIT Property (MergedArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_SERVICE\_UNIT](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLE_SERVICE_UNIT().html) | Performance unit (bill of quantities) # 26429. |
