# ARTICLE_NOMINAL_CAPACITY_PNEUMATIC Property (MDPartsDatabaseItemPropertyList)

ARTICLE\_NOMINAL\_CAPACITY\_PNEUMATIC Property (MDPartsDatabaseItemPropertyList)
...
| --- | --- |
| [ARTICLE\_NOMINAL\_CAPACITY\_PNEUMATIC](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_NOMINAL_CAPACITY_PNEUMATIC().html) | Nominal power (pneumatic) # 26477. |
