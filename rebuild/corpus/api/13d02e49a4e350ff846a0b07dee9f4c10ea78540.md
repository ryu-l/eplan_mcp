# FUNC_ARTICLE_RUN_UP_TIME Property (SegmentTemplatePropertyList)

FUNC\_ARTICLE\_RUN\_UP\_TIME Property (SegmentTemplatePropertyList)
...
| --- | --- |
| [FUNC\_ARTICLE\_RUN\_UP\_TIME](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentTemplatePropertyList~FUNC_ARTICLE_RUN_UP_TIME(Int32).html) | Start-up time # 26314. |
