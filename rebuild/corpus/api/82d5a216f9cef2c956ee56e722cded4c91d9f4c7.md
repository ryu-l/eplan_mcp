# ARTICLE_SERVICE_UNIT Property (MDPartsDatabaseItemPropertyList)

ARTICLE\_SERVICE\_UNIT Property (MDPartsDatabaseItemPropertyList)
...
| --- | --- |
| [ARTICLE\_SERVICE\_UNIT](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_SERVICE_UNIT().html) | Performance unit (bill of quantities) # 26429. |
