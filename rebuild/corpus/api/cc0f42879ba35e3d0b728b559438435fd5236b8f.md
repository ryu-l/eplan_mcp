# ARTICLE_PARTIAL_LENGTH Property (ArticlePropertyList)

ARTICLE\_PARTIAL\_LENGTH Property (ArticlePropertyList)
...
| --- | --- |
| [ARTICLE\_PARTIAL\_LENGTH](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_PARTIAL_LENGTH().html) | Subset / length # 20496. |
