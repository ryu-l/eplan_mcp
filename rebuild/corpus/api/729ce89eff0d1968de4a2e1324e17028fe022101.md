# FUNC_ARTICLE_ACTUAL_OUTPUT_PNEUMATIC_MAX Property (ProjectPropertyList)

FUNC\_ARTICLE\_ACTUAL\_OUTPUT\_PNEUMATIC\_MAX Property (ProjectPropertyList)
...
| --- | --- |
| [FUNC\_ARTICLE\_ACTUAL\_OUTPUT\_PNEUMATIC\_MAX(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectPropertyList~FUNC_ARTICLE_ACTUAL_OUTPUT_PNEUMATIC_MAX(Int32).html) | Actual power (pneumatic), max. # 26390. |
