...
| --- | --- |
| [CONNECTION\_FULLINSTALLATIONNUMBER\_AUTOMATIC](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~CONNECTION_FULLINSTALLATIONNUMBER_AUTOMATIC().html) | Higher-level function number (automatic) # 31111. |
