# ARTICLE_FREQUENCY_RANGE_MIN Property (ArticlePropertyList)

ARTICLE\_FREQUENCY\_RANGE\_MIN Property (ArticlePropertyList)
...
| --- | --- |
| [ARTICLE\_FREQUENCY\_RANGE\_MIN](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_FREQUENCY_RANGE_MIN().html) | Frequency range, min. # 26332. |
