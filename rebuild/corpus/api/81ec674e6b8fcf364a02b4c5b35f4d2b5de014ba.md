...
| --- | --- |
| [CDP\_CON\_DT](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionDefinitionPointPropertyList~CDP_CON_DT().html) | Associated connections: Device tag (identifying) # 31027. |
