# Group3DPropertyList Class Members

Group3DPropertyList Class Members

The following tables list the members exposed by [Group3DPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Group3DPropertyList.html).
