...
| --- | --- |
| [PART\_TERMINAL\_TERMINALSIZE\_DEFAULT](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPointsInfoPropertyList~PART_TERMINAL_TERMINALSIZE_DEFAULT().html) | Connection dimension (default) # 22969. |
