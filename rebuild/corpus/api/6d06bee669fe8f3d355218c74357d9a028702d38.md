...
| --- | --- |
| [PART\_TERMINAL\_TERMINALSIZE\_DEFAULT](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~PART_TERMINAL_TERMINALSIZE_DEFAULT().html) | Connection dimension (default) # 22969. |
