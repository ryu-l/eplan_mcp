# ARTICLE_GROUPSYMBOLMACRO_GB_CCC Property (MDPartsDatabaseItemPropertyList)

ARTICLE\_GROUPSYMBOLMACRO\_GB\_CCC Property (MDPartsDatabaseItemPropertyList)
...
| --- | --- |
| [ARTICLE\_GROUPSYMBOLMACRO\_GB\_CCC](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_GROUPSYMBOLMACRO_GB_CCC().html) | Schematic macro: GB/CCC # 22873. |
