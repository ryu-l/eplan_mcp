# ARTICLE_ERPNR_8 Property (MDPartsDatabaseItemPropertyList)

ARTICLE\_ERPNR\_8 Property (MDPartsDatabaseItemPropertyList)
...
| --- | --- |
| [ARTICLE\_ERPNR\_8](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_ERPNR_8().html) | ERP / PDM number 8 # 22377. |
