...
| --- | --- |
| [SYMBLIB\_ERRORSYMBOLED](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.SymbolLibraryPropertyList~SYMBLIB_ERRORSYMBOLED(Int32).html) | Error (symbol editor) # 15201. |
