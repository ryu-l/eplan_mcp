# FUNC_NESTEDCODE Property (MergedArticleReferencePropertyList)

FUNC\_NESTEDCODE Property (MergedArticleReferencePropertyList)
...
| --- | --- |
| [FUNC\_NESTEDCODE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~FUNC_NESTEDCODE().html) | DT (subordinate): Identifier # 20017. |
