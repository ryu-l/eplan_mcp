# ARTICLE_MAINTENANCE_INTERVAL Property (ArticlePropertyList)

ARTICLE\_MAINTENANCE\_INTERVAL Property (ArticlePropertyList)
...
| --- | --- |
| [ARTICLE\_MAINTENANCE\_INTERVAL](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_MAINTENANCE_INTERVAL().html) | Maintenance interval # 26635. |
