...
| --- | --- |
| [CONNECTION\_FULLPLANT\_AUTOMATIC](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~CONNECTION_FULLPLANT_AUTOMATIC().html) | Function designation (automatic) # 31101. |
