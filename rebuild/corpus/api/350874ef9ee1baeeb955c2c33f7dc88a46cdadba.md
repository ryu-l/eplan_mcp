# FUNC_DT2_COLUMN Property (MergedArticleReferencePropertyList)

FUNC\_DT2\_COLUMN Property (MergedArticleReferencePropertyList)
...
| --- | --- |
| [FUNC\_DT2\_COLUMN](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~FUNC_DT2_COLUMN().html) | DT (subordinate): Column # 20172. |
