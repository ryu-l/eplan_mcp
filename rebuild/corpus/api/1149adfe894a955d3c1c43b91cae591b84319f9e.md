# ARTICLE_MATERIAL_LIST Property (ConnectionPropertyList)

ARTICLE\_MATERIAL\_LIST Property (ConnectionPropertyList)
...
| --- | --- |
| [ARTICLE\_MATERIAL\_LIST](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~ARTICLE_MATERIAL_LIST().html) | Material selection list # 26656. |
