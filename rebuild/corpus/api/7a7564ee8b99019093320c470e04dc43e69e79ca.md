# ARTICLE_DISASSEMBLE_ADDONPARTS4 Property (MDPartsDatabaseItemPropertyList)

ARTICLE\_DISASSEMBLE\_ADDONPARTS4 Property (MDPartsDatabaseItemPropertyList)
...
| --- | --- |
| [ARTICLE\_DISASSEMBLE\_ADDONPARTS4](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_DISASSEMBLE_ADDONPARTS4().html) | Include supplemental parts (parts list / manufacturing data) # 22420. |
