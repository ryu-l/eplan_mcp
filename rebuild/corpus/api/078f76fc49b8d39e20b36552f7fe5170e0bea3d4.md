# DESIGNATION_FULLSUBINSTALLATIONNUMBER Property (PagePropertyList)

DESIGNATION\_FULLSUBINSTALLATIONNUMBER Property (PagePropertyList)
...
| --- | --- |
| [DESIGNATION\_FULLSUBINSTALLATIONNUMBER](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.PagePropertyList~DESIGNATION_FULLSUBINSTALLATIONNUMBER().html) | Higher-level function number (sub-identifier, complete) # 1721. |
