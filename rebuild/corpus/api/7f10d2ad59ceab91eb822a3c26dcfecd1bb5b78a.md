# ARTICLE_DISASSEMBLE_ADDONPARTS3 Property (ArticlePropertyList)

ARTICLE\_DISASSEMBLE\_ADDONPARTS3 Property (ArticlePropertyList)
...
| --- | --- |
| [ARTICLE\_DISASSEMBLE\_ADDONPARTS3](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_DISASSEMBLE_ADDONPARTS3().html) | Include supplemental parts (summarized parts list / manufacturing data) # 22419. |
