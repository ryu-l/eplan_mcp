# ARTICLE_STARTING_CURRENT_A Property (MergedArticleReferencePropertyList)

ARTICLE\_STARTING\_CURRENT\_A Property (MergedArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_STARTING\_CURRENT\_A](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLE_STARTING_CURRENT_A().html) | Starting current, max. # 26190. |
