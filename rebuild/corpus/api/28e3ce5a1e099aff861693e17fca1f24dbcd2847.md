...
| --- | --- |
| [DESIGNATION\_LOCATION\_PART](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentTemplatePropertyList~DESIGNATION_LOCATION_PART().html) | Location designation (single component) # 1228. |
