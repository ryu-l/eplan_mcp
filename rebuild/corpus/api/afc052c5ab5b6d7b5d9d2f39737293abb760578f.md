# ARTICLE_INTAKE_VOLUME_FLOW_MIN Property (ArticlePropertyList)

ARTICLE\_INTAKE\_VOLUME\_FLOW\_MIN Property (ArticlePropertyList)
...
| --- | --- |
| [ARTICLE\_INTAKE\_VOLUME\_FLOW\_MIN](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticlePropertyList~ARTICLE_INTAKE_VOLUME_FLOW_MIN().html) | Intake flow rate, min. # 26200. |
