...
| [Create(Project,String,String,Int32,List<Placement3D>)](topic485.html) | Creates not placed MountingPanel based on article which contain macro. |
| [Create(Project,Double,Double,Double,List<Placement3D>)](topic486.html) | Creates not placed, article free MountingPanel object with given dimensions. |
