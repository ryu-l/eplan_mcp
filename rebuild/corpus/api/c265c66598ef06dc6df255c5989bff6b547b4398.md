...
Returns [Eplan.EplApi.DataModel.Symbol](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MasterData.Symbol.html)s matching the given filter from the symbol navigator.
...
*strFilterScheme*
:   Scheme name of filter from the symbol navigator
