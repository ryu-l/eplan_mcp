# FUNC_ARTICLE_RUN_UP_TIME Property (ConnectionPropertyList)

FUNC\_ARTICLE\_RUN\_UP\_TIME Property (ConnectionPropertyList)
...
| --- | --- |
| [FUNC\_ARTICLE\_RUN\_UP\_TIME(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ConnectionPropertyList~FUNC_ARTICLE_RUN_UP_TIME(Int32).html) | Start-up time # 26314. |
