# ARTICLE_FLOW_DIRECTION Property (ArticleReferencePropertyList)

ARTICLE\_FLOW\_DIRECTION Property (ArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_FLOW\_DIRECTION](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~ARTICLE_FLOW_DIRECTION().html) | Flow direction: Operating flow direction # 26267. |
