# FUNC_ARTICLE_STRIPPING_LENGTH Property (ProjectPropertyList)

FUNC\_ARTICLE\_STRIPPING\_LENGTH Property (ProjectPropertyList)
...
| --- | --- |
| [FUNC\_ARTICLE\_STRIPPING\_LENGTH(Int32)](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ProjectPropertyList~FUNC_ARTICLE_STRIPPING_LENGTH(Int32).html) | Jacket (cable) stripping length # 31176. |
