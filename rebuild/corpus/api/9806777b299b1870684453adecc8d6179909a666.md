# FunctionDefinitionPropertyList Class

FunctionDefinitionPropertyList Class

This class represents a collection of properties of [FunctionDefinition](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionDefinition.html) class. Please also check the base classes for other properties that are available for [FunctionDefinition](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.FunctionDefinition.html) objects: [StorableObjectPropertyList](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.StorableObjectPropertyList.html)
...
- [C#](#i-tab-content-73d1e73e-003d-40c4-b09c-e384cee01c53)
