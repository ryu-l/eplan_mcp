# ARTICLE_ACTUAL_OUTPUT_HYDRAULIC Property (MergedArticleReferencePropertyList)

ARTICLE\_ACTUAL\_OUTPUT\_HYDRAULIC Property (MergedArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_ACTUAL\_OUTPUT\_HYDRAULIC](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLE_ACTUAL_OUTPUT_HYDRAULIC().html) | Actual power (hydraulic) # 26381. |
