# UnknownPrinter Class Members

UnknownPrinter Class Members

The following tables list the members exposed by [UnknownPrinter](Eplan.EplApi.HEServicesu~Eplan.EplApi.HEServices.Exceptions.UnknownPrinter.html).
