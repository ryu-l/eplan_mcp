...
| --- | --- |
| [FUNC\_DEVICETAG\_FULLNAME\_WITHSEPARATOR](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~FUNC_DEVICETAG_FULLNAME_WITHSEPARATOR().html) | Name (without project structures, with preceding sign) # 20214. |
