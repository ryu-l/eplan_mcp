...
| --- | --- |
| [DESIGNATION\_PLANT\_PART](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.Planning.SegmentTemplatePropertyList~DESIGNATION_PLANT_PART().html) | Function designation (single component) # 1128. |
