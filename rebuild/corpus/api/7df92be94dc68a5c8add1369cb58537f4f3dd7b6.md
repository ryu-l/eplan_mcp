# FUNC_PLCSYMBOLICADDRESS_UDT_DATATYPE Property (Placement3DPropertyList)

FUNC\_PLCSYMBOLICADDRESS\_UDT\_DATATYPE Property (Placement3DPropertyList)
...
| --- | --- |
| [FUNC\_PLCSYMBOLICADDRESS\_UDT\_DATATYPE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.E3D.Placement3DPropertyList~FUNC_PLCSYMBOLICADDRESS_UDT_DATATYPE().html) | Symbolic address: UDT (data type) # 20619. |
