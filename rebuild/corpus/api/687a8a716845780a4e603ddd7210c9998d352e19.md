# ARTICLE_POWER_CONTROL Property (MDPartsDatabaseItemPropertyList)

ARTICLE\_POWER\_CONTROL Property (MDPartsDatabaseItemPropertyList)
...
| --- | --- |
| [ARTICLE\_POWER\_CONTROL](Eplan.EplApi.MasterDatau~Eplan.EplApi.MasterData.MDPartsDatabaseItemPropertyList~ARTICLE_POWER_CONTROL().html) | Power control # 26048. |
