# ARTICLE_NOMINAL_VOLUME_FLOW Property (MergedArticleReferencePropertyList)

ARTICLE\_NOMINAL\_VOLUME\_FLOW Property (MergedArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_NOMINAL\_VOLUME\_FLOW](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MergedArticleReferencePropertyList~ARTICLE_NOMINAL_VOLUME_FLOW().html) | Nominal flow rate # 26506. |
