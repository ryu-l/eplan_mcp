# MACROFILE_CHANGEDATE Property (MacroBoxPropertyList)

MACROFILE\_CHANGEDATE Property (MacroBoxPropertyList)
...
| --- | --- |
| [MACROFILE\_CHANGEDATE](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.MacroBoxPropertyList~MACROFILE_CHANGEDATE().html) | Macro: Modification date # 23019. |
