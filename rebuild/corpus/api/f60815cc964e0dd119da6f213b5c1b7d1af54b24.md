# ARTICLE_PROTOCOL_BACNET Property (ArticleReferencePropertyList)

ARTICLE\_PROTOCOL\_BACNET Property (ArticleReferencePropertyList)
...
| --- | --- |
| [ARTICLE\_PROTOCOL\_BACNET](Eplan.EplApi.DataModelu~Eplan.EplApi.DataModel.ArticleReferencePropertyList~ARTICLE_PROTOCOL_BACNET().html) | BACnet: Protocol # 26540. |
