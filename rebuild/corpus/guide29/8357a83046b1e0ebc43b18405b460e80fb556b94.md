# Dialog Properties (<Graphical element>)

[![Closed](../../Skins/Default/Stylesheets/Images/transparent.gif)Dialog call:](javascript:void(0);)

You have opened a page, [form](Glossary_o_verlauf.htm), plot frame, or symbol. You have marked a graphical element and selected the menu [items](Glossary_o_bauteile.htm) Edit > Properties, or you have double-clicked a graphical element.

In this dialog, you can edit the display [properties](Glossary_o_eigenschaften.htm) of graphical elements like [lines](Glossary_o_leitungen.htm), circles, rectangles, etc.
...
Here you determine specific [settings](Glossary_o_einstellungen.htm) for the graphical element such as, e.g., coordinate and length entries. Depending on the type of graphical element, one of the following hierarchy levels will be displayed here:
