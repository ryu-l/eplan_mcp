...
In this example the class SimpleScript with the function MyFunction is generated. The function is marked by the [Start] attribute. If the script is executed by the menu [items](Glossary_o_bauteile.htm) Utilities > Scripts > Run, the MyFunction was called! message appears.   
