...
| TYPE | Type of task to perform the action. Possible values are: PROJECT: Check project PAGE: Check page INSTALLATIONSPACE: Check [layout space](Glossary_o_bauraum.htm) |
...
| SELn | Object [ID](Glossary_o_id.htm) of the pages to be checked (optional). Here, n is a number, e.g., /SEL1:38/4/12/0. Alternative to PAGENAME. This parameter has an effect only if the TYPE parameter has the following value: PAGE. |
