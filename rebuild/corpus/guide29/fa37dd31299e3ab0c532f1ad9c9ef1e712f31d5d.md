...
You have opened a project. The project is not write-protected. Options > Settings > Projects > 'Project name' > Management > Revision (graphical representation).

In this dialog you can specify the [settings](Glossary_o_einstellungen.htm) for the display of [revision markers](Glossary_o_revisionsmarkierungen.htm). The settings for the display of graphical markers apply both to revision markers displayed via [change tracking](Glossary_o_aenderungsverfolgung.htm), and to those generated after a property comparison of [projects](Glossary_o_projekte.htm).

Overview of the main dialog elements:

Added / Changed / New in report / Deleted tabs

Here you specify how the graphical markers for revision changes should look. These settings can be made separately for added, changed, new in report, and deleted [objects](Glossary_o_objekte.htm) in the Added, Changed, New in report, and Deleted tabs.

![](../Pictures/Gui/ALL/note.png)Note:

Please note that the graphical marker for the "New in report" revision change is only used in change tracking, and does not work in [master data](Glossary_o_stammdaten.htm) [reports](Glossary_o_auswertungen.htm) ([forms](Glossary_o_formulare.htm) documentation, plot frame documentation, etc.).
...
In [revision projects](Glossary_o_revisionsprojekte.htm) with change tracking, changes in the [properties](Glossary_o_eigenschaften.htm) are displayed by means of a marker text which is entered in the Revision marker (change tracking) property.
