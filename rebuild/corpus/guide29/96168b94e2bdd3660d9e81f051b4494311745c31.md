...
To allow multi-line text in [forms](Glossary_o_formulare.htm), special setting options are provided under the Alignment box property on the [Format](gededitgui_r_format.htm) tab in the Properties dialog for texts / placeholder text.
