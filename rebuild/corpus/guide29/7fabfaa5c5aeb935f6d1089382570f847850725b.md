...
The [devices](Glossary_o_betriebsmittel.htm) of an enclosure and NC-relevant [cut-outs](Glossary_o_durchbrueche.htm) ([drill holes](Glossary_o_bohrungen.htm), sections, etc.) represented in the views and copper unfolds can be dimensioned automatically. The [items](Glossary_o_bauteile.htm) to be dimensioned and the [properties](Glossary_o_eigenschaften.htm) of the dimensioning can be stored as [project-specific settings](Glossary_o_projektbezogeneeinstellungen.htm) in a scheme. You insert the automatic dimensioning by selecting a corresponding scheme in the [property dialog](Glossary_o_eigenschaftendialog.htm). To this purpose the Model view: Scheme for automatic dimensioning property is available in the Properties table on the View tab.
...
- In the 2D [panel layout](Glossary_o_schaltschrankaufbau.htm) or other graphical representations.
...
Model view with automatic dimensioning for [mounting rails](Glossary_o_tragschienen.htm)
