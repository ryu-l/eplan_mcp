...
| TYPE | Type of action that is to be executed:  RouteConnections: Routes selected [topology](Glossary_o_topologie.htm) [connections](Glossary_o_verbindungen.htm). CreateFunctions: Generates topology [functions](Glossary_o_funktionen.htm) automatically. |
