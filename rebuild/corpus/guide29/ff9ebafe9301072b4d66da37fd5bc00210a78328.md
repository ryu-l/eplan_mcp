...
- You have inserted a new interruption point or have double-clicked an interruption point (or selected the Properties popup menu item; in which case several [interruption points](Glossary_o_abbruchstellen.htm) can be selected). In the Properties <...> dialog, select the Interruption point tab.
...
In this dialog you specify the [properties](Glossary_o_eigenschaften.htm) for the selected interruption point(s). The Properties <...> dialog is available for placed interruption points.
