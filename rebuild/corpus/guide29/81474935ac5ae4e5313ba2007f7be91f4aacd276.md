...
During the export of the [wire fabrication](Glossary_o_drahtkonfektionierung.htm) data, a missing and / or incorrect setting was determined.
...
- Bundle split - number of [wires](Glossary_o_draehte.htm) too high
...
2. Export the wire fabrication data again.
