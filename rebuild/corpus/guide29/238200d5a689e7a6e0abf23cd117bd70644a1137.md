...
P&I diagrams are [part](Glossary_o_artikel.htm) of the plant documentation. As standard, P&I diagrams are used for the following:

- Representation of a [process engineering](Glossary_o_verfahrenstechnik.htm) piping
- Representation of a plant overview with associated instrumentation
- Functional overview drawings of machines.

P&I diagrams are often called P&IDs (Piping and Instrumentation Diagrams) or P&I [schemes](Glossary_o_schemata.htm) (Piping and Instrumentation Schemes). The term "[P&I diagram](Glossary_o_ri_fliessbild.htm)" is used in EPLAN.
...
- General information on the apparatus, [pipings](Glossary_o_rohrleitungen.htm), and control valves
- Measurement, regulation, and controlling [functions](Glossary_o_funktionen.htm) with identification numbers
...
- Type of important [devices](Glossary_o_betriebsmittel.htm) for measuring, control, and regulation processes
