...
- You have selected a project in the page navigator. Project > Organize > Synchronize.

In this dialog you define which [project data](Glossary_o_projektdaten.htm) is to be updated and completed in a target project.

Not only the project pages and [master data](Glossary_o_stammdaten.htm) belong to a project, but also project [settings](Glossary_o_einstellungen.htm), report templates and other data such as [layers](Glossary_o_ebenen.htm), [user-defined](Glossary_o_benutzerdefiniert.htm) [properties](Glossary_o_eigenschaften.htm), property arrangements, etc. By means of this synchronization dialog you can specifically transfer the project settings and project data from a source project. In the process these data are copied into the target project.
