# Dialog Translate / Multilingual input
...
- You have selected a text or a path function text and the menu [items](Glossary_o_bauteile.htm) Edit > Properties or have double-clicked a text or path function text. Select the Text tab. Enter a word without multiple meanings. Popup menu > Translate or Popup menu > Multilingual input.
...
This dialog displays all available translation texts for the selected [translation languages](Glossary_o_uebersetzungssprachen.htm).
...
The dictionary only contains the languages , de\_DE and ru\_RU.

Under the Options > Settings > Projects > "Project name" > Translation > General menu items, you have selected fr\_FR as translation and source language. If you now insert a text, the button is not available because the keyword language (fr\_FR) is not present in the dictionary.
