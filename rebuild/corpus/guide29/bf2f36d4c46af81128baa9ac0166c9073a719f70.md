...
- Options > Settings > User > Graphical editing > 2D. In the Color settings group box, click [...] in one of the fields.
- You have opened a project. You have inserted or selected a [component](Glossary_o_schaltzeichen.htm), a graphical element, or a text and have opened the [properties](Glossary_o_eigenschaften.htm) dialog. Or you have selected a function in one of the [project data](Glossary_o_projektdaten.htm) [navigators](Glossary_o_navigatoren.htm) and opened its properties dialog. Switch to the Display or Format tab (depending on the selected object), and in the Color field, click [...].
...
This button is for the color [settings](Glossary_o_einstellungen.htm) of [symbols](Glossary_o_symbole.htm). Symbols are then displayed as standard in the colors used for the symbol creation and that are entered at the symbol.
